<?php
/* --------------------------------------------------------------
   GoogleConversionTrackingCheckoutSuccessExtender.inc.php 2012-12-13 gm
   Gambio GmbH
   http://www.gambio.de
	...
	function proceed()
	{
			...
			&& is_object($this->v_data_array['coo_order']) )
		{
			...
			$t_html = '
				...
				<img height="1" width="1" style="border-style:none;" alt="" src="https://www.googleadservices.com/pagead/conversion/' . GOOGLE_CONVERSION_ID . '/?value=0&amp;label=' . GOOGLE_CONVERSION_LABEL . '&amp;guid=ON&amp;script=0"/>
				</div>
				</noscript>
			';
