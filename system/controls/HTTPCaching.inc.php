<?php
/* --------------------------------------------------------------
   HTTPCaching.inc.php 2012-12-12 mb
   Gambio GmbH
   http://www.gambio.de
...
class HTTPCaching
{
	...
	function HTTPCaching()
	{
		...
		$this->v_exclude_array[] = 'fckeditor';
		$this->v_exclude_array[] = 'gm_create_vvcodes.php';
		$this->v_exclude_array[] = 'gm_javascript.js.php';		
		$this->v_exclude_array[] = 'gm_gprint_download.php';
	}
