/* CartControl.js <?php
#   --------------------------------------------------------------
#   CartControl.js 2012-05-30 gambio
#   Gambio GmbH
#   http://www.gambio.de
			...
			success: function(p_result)
					 {
						...
						if(coo_this.need_fixed_cart() == false)
						{
							...
							// start timeout for closing the dropdown
							setTimeout('coo_cart_control.close_dropdown()', 5000);
						}
					 }
		 });
	}
