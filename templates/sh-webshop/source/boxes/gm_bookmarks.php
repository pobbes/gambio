<?php
/* --------------------------------------------------------------
   gm_bookmarks.php 2010-09-30 gambio
   Gambio GmbH
   http://www.gambio.de
...
$coo_bookmarks = MainFactory::create_object('BookmarksContentView');
$f_manufacturers_id = false;
if(!empty($_GET['manufacturers_id']))
{
	$f_manufacturers_id = $_GET['manufacturers_id'];
}
$t_box_html = $coo_bookmarks->get_html($product, $f_manufacturers_id);
