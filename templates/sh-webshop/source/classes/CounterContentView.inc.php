<?php
/* --------------------------------------------------------------
   CounterContentView.inc.php 2010-09-24 gambio
   Gambio GmbH
   http://www.gambio.de
...
class CounterContentView extends ContentView
{
	function CounterContentView()
	{
	...
	function get_html()
	{
		...
		$this->set_content_data('GM_HITS',	$t_hits_array['hits']);
		$this->set_content_data('GM_DATE',	xtc_date_short($t_date_array['date']));
		$this->set_content_data('GM_ONLINE',	$t_online_array['online']);
