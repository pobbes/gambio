<?php
/* --------------------------------------------------------------
   AccordionSubmenusContentView.inc.php 2011-08-29 gambio
   Gambio GmbH
   http://www.gambio.de
...
class AccordionSubmenusContentView extends ContentView
{
	var $v_customers_status_id = false;
	var $v_language = false;
	var $v_currency = false;

	function AccordionSubmenusContentView()
	{
		$this->set_content_template('module/accordion_submenu.html');
	...
	function get_html($p_cPath, $p_parent_categories_id = 0)
	{
		...
		{
			# Categories Submenus
			$coo_categories_content_view = MainFactory::create_object('AccordionMenuContentView');
			$coo_categories_content_view->set_content_template('module/accordion_submenu.html');
