<?php
/* --------------------------------------------------------------
   EkomiContentView.inc.php 2011-11-22 gm
   Gambio GmbH
   http://www.gambio.de
...
class EkomiContentView extends ContentView
{
	function EkomiContentView()
	{
	...
	function get_html()
	{
		...
		$this->set_content_data('WIDGET_CODE', $t_widget_code);
