...
/* --------------------------------------------------------------
   ...
   extrabox3.php 2008-08-09 gambio
...
$content_query = xtDBquery("SELECT
					...
					*
 					...
 					WHERE
						...
						content_group='63' and languages_id = '".$_SESSION['languages_id']."'
...

{
  ...
  $box_content= $box_smarty->fetch(CURRENT_TEMPLATE.'/boxes/box_extrabox3.html');
  ...
  $box_content= $box_smarty->fetch(CURRENT_TEMPLATE.'/boxes/box_extrabox3.html',$cache_id);
			...
			$gm_box_pos = $coo_template_control->get_menubox_position('extrabox3');
