...
$box_smarty->assign('FORM_ACTION', xtc_draw_form('sign_in', xtc_href_link(FILENAME_NEWSLETTER, '', 'NONSSL', true, true, true)));
$box_smarty->assign('FIELD_EMAIL',xtc_draw_input_field('email', '', 'size="14" maxlength="50"'));
...
$box_smarty->assign('FORM_END','</form>');
  ...
  $box_newsletter= $box_smarty->fetch(CURRENT_TEMPLATE.'/boxes/box_newsletter.html',$cache_id);
	...
	$smarty->assign($gm_box_pos, $box_newsletter);
?>