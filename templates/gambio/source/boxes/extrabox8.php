...
/* --------------------------------------------------------------
   ...
   extrabox8.php 2008-08-09 gambio
...
$content_query = xtDBquery("SELECT
					...
					*
 					...
 					WHERE
						...
						content_group='68' and languages_id = '".$_SESSION['languages_id']."'
...
if($_SESSION['style_edit_mode'] != 'edit') $box_smarty->assign('BOX_CONTENT', $content_body );	
  ...
  $box_content= $box_smarty->fetch(CURRENT_TEMPLATE.'/boxes/box_extrabox8.html');
  ...
  $box_content= $box_smarty->fetch(CURRENT_TEMPLATE.'/boxes/box_extrabox8.html',$cache_id);
			...
			$gm_box_pos = $coo_template_control->get_menubox_position('extrabox8');
