...
/* --------------------------------------------------------------
   ...
   extrabox4.php 2008-08-09 gambio
...
$content_query = xtDBquery("SELECT
					...
					*
 					...
 					WHERE
						...
						content_group='64' and languages_id = '".$_SESSION['languages_id']."'
...
if($_SESSION['style_edit_mode'] != 'edit') $box_smarty->assign('BOX_CONTENT', $content_body );	
  ...
  $box_content= $box_smarty->fetch(CURRENT_TEMPLATE.'/boxes/box_extrabox4.html');
  ...
  $box_content= $box_smarty->fetch(CURRENT_TEMPLATE.'/boxes/box_extrabox4.html',$cache_id);
  ...
  //GM_MOD:
			...
			$gm_box_pos = $coo_template_control->get_menubox_position('extrabox4');
