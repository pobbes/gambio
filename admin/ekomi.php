...
<table style="border: 1px solid #dddddd" border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr class="dataTableRow">
		<td style="font-size: 12px; padding: 0px 10px 12px 10px; text-align: justify">
			<img style="float: right; margin: 10px 0px 10px 20px" src="images/ekomi.png" alt="" /><br />
			...
			<br />
			<br />
			<?php echo EKOMI_SEND_MAILS_URL_TEXT . ' <a href="' . HTTP_SERVER . DIR_WS_CATALOG . 'request_port.php?module=EkomiSendMails&token=' .  FileLog::get_secure_token() . '" target="_blank">' . HTTP_SERVER . DIR_WS_CATALOG . 'request_port.php?module=EkomiSendMails&token=' .  FileLog::get_secure_token() . '</a>'; ?>
			<br />
			<br />
			<?php } ?>			
			</form>
