...
define('YOOCHOOSE_MODELS_POSITION_HINT',
    'You can change the position of the Die Positionierung einzelner Boxen auf der Seite können Sie im Administrationsbereich unter 
     <a href="%1$s">Template-Einstellungen</a> ändern.');

define('YOOCHOOSE_MODELS_POSITION_NO_STYLEEDIT', 
    'StyleEdit Plugin is not installed. It is not possible to activate/deactivate the recommendation 
     side boxes over the web interface. <a href="%1$s">More&nbsp;information...</a>');
...
define('YOOCHOOSE_ERROR_LOADING_STRATEGIES', 
        'Unable to load avaliable recommendation scenarios. 
         Please check you customer ID and license key! Error message: %1$s');
...
define('YOOCHOOSE_REGISTER_BTN', 'Register');
define('YOOCHOOSE_REGISTER_CONTENT',
        'I have no YOOCHOOSE ID yet.');

define('YOOCHOOSE_ACTIVATE_BTN', 'Activate');
define('YOOCHOOSE_ACTIVATE_CONTENT',
        'I have already a YOOCHOOSE ID.');



define('YOOCHOOSE_ACTIVATE_POSTINFO',
    'The registration form on YOOCHOOSE website will be pre-filled for you. Following information from the shop
     system will be transfered over a secure connection: your name, company name and address. 
     If you want to avoid the data transmission, please use a <a target="_blank" href="%1$s">blank registration form. </a>');
...
define('YOOCHOOSE_STRATEGY', 'recommendation type');
define('YOOCHOOSE_MAX_RECOMMENDATIONS', 'displayed articles');
