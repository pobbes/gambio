...
define('YOOCHOOSE_MODELS_POSITION_HINT',
    'Die Positionierung einzelner Boxen auf der Seite können Sie im Administrationsbereich unter 
     <a href="%1$s">Template-Einstellungen</a> ändern.');

define('YOOCHOOSE_MODELS_POSITION_NO_STYLEEDIT', 
    'Das StyleEdit Plugin ist nicht installiert. Das Aktivieren von Seitenboxes über das Web-Interface 
     ist nicht möglich. <a href="%1$s">Mehr&nbsp;Information...</a>');
...
define('YOOCHOOSE_ERROR_LOADING_STRATEGIES', 
        'Die verfügbaren Scenarien können nicht geladen werden. 
         Überprüfen Sie Ihre Kundennummer und Lizenzschlüssel. Fehlermeldung: %1$s');
...
define('YOOCHOOSE_ACTIVATE_POSTINFO',
    'Das Registrierungsformular auf der YOOCHOOSE Webseite wird für Sie bereits vorausgefüllt. 
    Ihr Name, Firmenname und Adresse werden aus dem Shop System übertragen. Alternativ können
