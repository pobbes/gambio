<?php
/* --------------------------------------------------------------
   coupon_admin.php 2009-11-24 gm
   Gambio GmbH
   http://www.gambio.de
...
based on:
  ...
  switch ($_GET['action']) {
    // BOF GM_MOD
      ...
      xtc_db_query("update " . TABLE_COUPONS . " set coupon_active = 'N' where coupon_id='".$_GET['cid']."'");
      break;
		case 'voucher_set_active':
      xtc_db_query("update " . TABLE_COUPONS . " set coupon_active = 'Y' where coupon_id='".$_GET['cid']."'");
      break;
		case 'confirmdelete':
      xtc_db_query("DELETE FROM " . TABLE_COUPONS . " WHERE coupon_id='".$_GET['cid']."'");
			xtc_db_query("DELETE FROM coupons_description WHERE coupon_id='".$_GET['cid']."'");
			xtc_db_query("DELETE FROM coupon_email_track WHERE coupon_id='".$_GET['cid']."'");
			xtc_db_query("DELETE FROM coupon_redeem_track WHERE coupon_id='".$_GET['cid']."'");
      break;
    // EOF GM_MOD
		case 'update':
...
?>
 <?php if (is_object($cc_split)) { ?>
              <tr>
                ...
                <td align="right" class="smallText">&nbsp;<?php echo $cc_split->display_links($cc_query_numrows, '20', MAX_DISPLAY_PAGE_LINKS, $_GET['page'],xtc_get_all_get_params(array('page','uid'))); ?>&nbsp;</td>
              </tr>
            <?php } ?>
      ...
      <tr>
          <tr><?php echo xtc_draw_form('mail', FILENAME_COUPON_ADMIN, 'action=send_email_to_user&cid=' . $_GET['cid']); ?>
            <td><table border="0" width="100%" cellpadding="0" cellspacing="2" class="gm_border dataTableRow">
              ...
              <tr>
                <td class="smallText"><b><?php echo TEXT_MESSAGE; ?></b><br /><?php echo nl2br(htmlspecialchars_wrapper(stripslashes($_POST['message']))); ?></td>
              </tr>
              <tr>
                <td><?php echo xtc_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
              </tr>
...
?>
                <table border="0" width="100%" cellpadding="0" cellspacing="2">
                  <tr>
                    <td><?php echo '<a class="button" onClick="this.blur();" href="' . xtc_href_link(FILENAME_COUPON_ADMIN) . '">' . BUTTON_CANCEL . '</a>'; ?></td>
                    <td align="right"><?php echo '<input type="submit" class="button" onClick="this.blur();" value="' . BUTTON_SEND_EMAIL . '"/>'; ?></td>
                  </tr>
                </table></td>
              </tr>
            </table></td>
...
?>
      ...
      <tr>
          ...
          <tr><?php echo xtc_draw_form('mail', FILENAME_COUPON_ADMIN, 'action=preview_email&cid='. $_GET['cid']); ?>
            <td><table width="100%" border="0" cellpadding="0" cellspacing="2" class="gm_border dataTableRow">
<?php
    $customers = array();
...
?>
              ...
              <tr>
                <td colspan="2" align="left"><?php echo '<input type="submit" class="button" onClick="this.blur();" value="' . BUTTON_SEND_EMAIL . '"/>'; ?></td>
              </tr>
            </table></td>
          </form></tr>
...
?>
      ...
      <tr>
      <td class="gm_border dataTableRow">
...
?>
      <tr>
        <td class="main" width="150" align="left"><?php echo COUPON_NAME; ?></td>
...
?>
      <tr>
        <td class="main" align="left"><?php echo COUPON_DESC; ?></td>
...
?>
      <tr>
        <td class="main" align="left"><?php echo COUPON_AMOUNT; ?></td>
        <td class="main" align="left"><?php echo $_POST['coupon_amount']; ?></td>
      </tr>
 
      <tr>
        <td class="main" align="left"><?php echo COUPON_MIN_ORDER; ?></td>
        <td class="main" align="left"><?php echo $_POST['coupon_min_order']; ?></td>
      </tr>

      <tr>
        <td class="main" align="left"><?php echo COUPON_FREE_SHIP; ?></td>
<?php
    if ($_POST['coupon_free_ship']) {
?>
        <td class="main" align="left"><?php echo TEXT_FREE_SHIPPING; ?></td>
<?php
    } else { 
?>
        <td class="main" align="left"><?php echo TEXT_NO_FREE_SHIPPING; ?></td>
<?php
    }
?>
      </tr>
      <tr>
        <td class="main" align="left"><?php echo COUPON_CODE; ?></td>
<?php
    if ($_POST['coupon_code']) {
...
?>
      ...
      <tr>
        <td class="main" align="left"><?php echo COUPON_USES_COUPON; ?></td>
        <td class="main" align="left"><?php echo $_POST['coupon_uses_coupon']; ?></td>
      </tr>

      <tr>
        <td class="main" align="left"><?php echo COUPON_USES_USER; ?></td>
        <td class="main" align="left"><?php echo $_POST['coupon_uses_user']; ?></td>
      </tr>
      
       <tr>
        <td class="main" align="left"><?php echo COUPON_PRODUCTS; ?></td>
        <td class="main" align="left"><?php echo $_POST['coupon_products']; ?></td>
      </tr>


      <tr>
        <td class="main" align="left"><?php echo COUPON_CATEGORIES; ?></td>
        <td class="main" align="left"><?php echo $_POST['coupon_categories']; ?></td>
      </tr>
      <tr>
        <td class="main" align="left"><?php echo COUPON_STARTDATE; ?></td>
<?php
...
?>
      ...
      <tr>
        <td class="main" align="left"><?php echo COUPON_FINISHDATE; ?></td>
<?php
...
?>
        <td class="main" align="left"><?php echo $finish_date; ?></td>
      </tr>
<?php
        $languages = xtc_get_languages();
        for ($i = 0, $n = sizeof($languages); $i < $n; $i++) {
...
?>
     ...
     <tr>
        <td class="main" align="left" colspan="2">
			<?php echo '<input type="submit" name="back" class="button float_left" onClick="this.blur();" value="' . BUTTON_BACK . '"/>'; ?>
			<?php echo '<input type="submit" class="button float_left" onClick="this.blur();" value="' . BUTTON_CONFIRM . '"/>'; ?>
		</td>
      </tr>
...
?>
      <table border="0" width="100%" cellspacing="0" cellpadding="6" class="gm_border dataTableRow">
<?php
        $languages = xtc_get_languages();
        for ($i = 0, $n = sizeof($languages); $i < $n; $i++) {
        $language_id = $languages[$i]['id'];
...
?>
      ...
      <tr>
        <td align="left" colspan="3"><?php echo '<input type="submit" class="button float_right" onClick="this.blur();" value="' . BUTTON_PREVIEW . '"/><a class="button float_right" onClick="this.blur();" href="' . xtc_href_link('coupon_admin.php', ''); ?>"><?php echo BUTTON_CANCEL; ?></a></td>
      </td>
      </tr>
      </td></table></form>
      </tr>
    ...
    <td  class="boxCenter" width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
      <tr>
        <td width="100%"><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
			<td width="100%">
				<div class="pageHeading" style="float:left; background-image:url(images/gm_icons/hilfsprogr2.png)">
    ...
    default:
      ...
      if ($cInfo->coupon_type == 'P') {
        ...
        $contents[] = array('text'=> TEXT_CONFIRM_DELETE . '</br></br>' . 
                '<div align="center"><a class="button" onClick="this.blur();" href="'.xtc_href_link('coupon_admin.php','action=confirmdelete&cid='.$_GET['cid'],'NONSSL').'">'.BUTTON_CONFIRM.'</a></div>' .
                '<div align="center"><a class="button" onClick="this.blur();" href="'.xtc_href_link('coupon_admin.php','cid='.$cInfo->coupon_id,'NONSSL').'">'.BUTTON_CANCEL.'</a></div>'
                );
      } else { 
        $prod_details = NONE;
        ...
        $coupon_name = xtc_db_fetch_array($coupon_name_query);
				...
				$gm_status = '';
				if($_GET['status'] == 'N'){
					$gm_change_coupon_status = '<a class="button" onClick="this.blur();" href="'.xtc_href_link('coupon_admin.php','action=voucher_set_active&cid='.$cInfo->coupon_id,'NONSSL').'">'.BUTTON_STATUS_ON.'</a>';
        	$gm_status = '&status=N';
				}
				else $gm_change_coupon_status = '<a class="button" onClick="this.blur();" href="'.xtc_href_link('coupon_admin.php','action=voucher_set_inactive&cid='.$cInfo->coupon_id,'NONSSL').'">'.BUTTON_STATUS_OFF.'</a>';             
				...
				$contents[] = array('text'=>COUPON_NAME . '&nbsp;::&nbsp; ' . $coupon_name['coupon_name'] . '<br />' .
                     ...
                     $gm_change_coupon_status .
										 '<a class="button" onClick="this.blur();" href="'.xtc_href_link('coupon_admin.php','action=voucherdelete&cid='.$cInfo->coupon_id.$gm_status,'NONSSL').'">'.BUTTON_DELETE.'</a>' .
