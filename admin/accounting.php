<?php
/* --------------------------------------------------------------
   accounting.php 2008-05-05 gambio
   Gambio OHG
   http://www.gambio.de
...
<!-- body_text //-->
    <td class="boxCenter" width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
        <td>
		<div class="pageHeading" style="background-image:url(images/gm_icons/kunden.png)"><?php echo TEXT_ACCOUNTING.' '.$allow_edit['customers_lastname'].' '.$allow_edit['customers_firstname']; ?></div>
		<br>		
		</td>
      </tr>
      <tr>
