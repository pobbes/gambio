...
<!-- body_text //-->
    <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="2"  class="gm_border dataTableRow">
<?php
  if ( ($_GET['action'] == 'preview') && ($_POST['customers_email_address']) ) {
    switch ($_POST['customers_email_address']) {
      case '***':
              ...
              <tr>
                ...
                <td>
									...
									// BOF GM_MOD
										...
										echo xtc_draw_textarea_field('message', 'soft', '100%', '30', htmlspecialchars_wrapper($_POST['message']));
									}
									// EOF GM_MOD
									?>
								</td>
