<?php
/* --------------------------------------------------------------
   campaigns.php 2008-05-08 gambio
   Gambio OHG
   http://www.gambio.de
...
switch ($_GET['action']) {
	case 'new' :
		...
		$contents[] = array ('align' => 'center', 'text' => '<br /><div align="center">'.xtc_button(BUTTON_SAVE).''.xtc_button_link(BUTTON_CANCEL, xtc_href_link(FILENAME_CAMPAIGNS, 'page='.$_GET['page'].'&cID='.$_GET['cID'])). '</div>');
		break;
	...
	case 'edit' :
		...
		$contents[] = array ('align' => 'center', 'text' => '<br /><div align="center">'.xtc_button(BUTTON_SAVE).''.xtc_button_link(BUTTON_CANCEL, xtc_href_link(FILENAME_CAMPAIGNS, 'page='.$_GET['page'].'&cID='.$cInfo->campaigns_id)). '</div>');
		break;
	...
	case 'delete' :
		...
		$contents[] = array ('align' => 'center', 'text' => '<br /><div align="center">'.xtc_button(BUTTON_DELETE).''.xtc_button_link(BUTTON_CANCEL, xtc_href_link(FILENAME_CAMPAIGNS, 'page='.$_GET['page'].'&cID='.$cInfo->campaigns_id)) . '</div>');
		break;
	...
	default :
		if (is_object($cInfo)) {
			...
			$contents[] = array ('align' => 'center', 'text' => '<div align="center">' . xtc_button_link(BUTTON_EDIT, xtc_href_link(FILENAME_CAMPAIGNS, 'page='.$_GET['page'].'&cID='.$cInfo->campaigns_id.'&action=edit')).''.xtc_button_link(BUTTON_DELETE, xtc_href_link(FILENAME_CAMPAIGNS, 'page='.$_GET['page'].'&cID='.$cInfo->campaigns_id.'&action=delete')) . '</div>');
