<?php
/* --------------------------------------------------------------
   gm_bookmarks_action.php 2008-08-08 gambio
   Gambio OHG
   http://www.gambio.de
	...
	switch(($_GET['action'])) {
		...
		case 'gm_bookmarks':
			...
			if(!empty($gm_bookmarks)) {
				include(DIR_FS_ADMIN . 'gm/gm_bookmarks/gm_bookmarks.php');
			} else {
		...
		case 'gm_edit_bookmarks':
			...
			include(DIR_FS_ADMIN . 'gm/gm_bookmarks/gm_edit_bookmarks.php');
		...
		case 'gm_bookmarks_options':
			...
			include(DIR_FS_ADMIN . 'gm/gm_bookmarks/gm_bookmarks_options.php');
