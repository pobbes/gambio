<?php
/* --------------------------------------------------------------
   gm_order_menu.php 2010-08-18 gm
   Gambio GmbH
   http://www.gambio.de
...
if($_GET['type'] == 'order') {
	...
	<table border="0" width="100%" cellspacing="2" cellpadding="3">
		...
		<tr>
			...
			<td valign="top" class="main">
				<input type="text" id="gm_subject" value="' . utf8_decode(ORDER_SUBJECT . $oID . ORDER_SUBJECT_FROM . $order_date) . '" size="45" maxlength="255" />
			</td>
		</tr>
		<tr>
			<td valign="top" class="main">
		...
		<tr>
			<td colspan="2" valign="top" class="main">
				<span onclick="gm_mail_send(\'gm_send_order.php\', \'&type=send_order\', \'ORDERS_MAIL\')" class="button float_right" id="gm_save">' . TITLE_SEND . '</span>
				<span onclick="gm_mail_close(\'ORDERS_MAIL\')" class="button float_right" id="gm_close">' . TITLE_BREAK . '</span>												  
			</td>
		</tr>
	</table>';
	...
	if($order_check['orders_status'] == gm_get_conf('GM_ORDER_STATUS_CANCEL_ID')) {
		...
		<table border="0" width="100%" cellspacing="2" cellpadding="3">
			...
			<tr>
				<td colspan="2" valign="top" class="main" align="">
					<span onclick="gm_mail_close(\'CANCEL\')" class="button float_right" id="gm_close">' . TITLE_BREAK . '</span>												  
				</td>
			</tr>
		</table>';
		...
		<table border="0" width="100%" cellspacing="2" cellpadding="3">
			...
			<tr>
				...
				<td valign="top" class="main">
					<input type="text" id="gm_subject" value="' . utf8_decode(TITLE_GM_CANCEL_SUBJECT_1 . $oID . TITLE_GM_CANCEL_SUBJECT_2 . $cancel_date . TITLE_GM_CANCEL_SUBJECT_3) . '" size="45" maxlength="255" />
				</td>
			</tr>
			<tr>
				<td valign="top" class="main">
			...
			<tr>
				...
				<td valign="top" class="main">
					' . xtc_draw_textarea_field('gm_comment', '', 42, 6) . '</textarea>
				</td>
			</tr>
			<tr>
				<td colspan="2" valign="top" class="main" align="">
					<span onclick="gm_cancel(\'gm_send_order.php\', \'&type=cancel\', \'CANCEL\')" class="button float_right" id="gm_save">' . TITLE_SEND . '</span>
					<span onclick="gm_mail_close(\'CANCEL\')" class="button float_right" id="gm_close">' . TITLE_BREAK . '</span>												  
				</td>
			</tr>
		</table>';
	...
	<table border="0" width="100%" cellspacing="2" cellpadding="3">
		...
		<tr>
			<td colspan="2" valign="top" class="main">
				<span onclick="gm_mail_send(\'gm_pdf_order.php\', \'&type=invoice&mail=1&gm_quick_mail=1\', \'INVOICE_MAIL\')" class="button float_right" id="gm_save">' . TITLE_SEND . '</span>
				<span onclick="gm_mail_close(\'INVOICE_MAIL\')" class="button float_right" id="gm_close">' . TITLE_BREAK . '</span>												  
			</td>
		</tr>
	</table>';
}
