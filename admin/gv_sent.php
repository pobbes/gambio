...
<?php
  ...
  if ($redeemed=='Yes') {
	...
	// BOF GM_MOD:
	if(!empty($gInfo->coupon_id)) $contents[] = array('text' => '<br /><div align="center"><a class="button" onclick="return confirm(\'' . GM_GV_DELETE . '\')" href="' . xtc_href_link('gv_sent.php','action=delete&gid=' . $gInfo->coupon_id ,'NONSSL'). '">' . BUTTON_DELETE . '</a></div>');
