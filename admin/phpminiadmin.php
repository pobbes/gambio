...
$ACCESS_PWD=''; #!!!IMPORTANT!!! this is script access password, SET IT if you want to protect you DB from public access
 ...
 # --- WARNING! --- if you set defaults - always recommended to set $ACCESS_PWD to protect your db!
	 $DBDEF=array(
	 'user'	=> DB_SERVER_USERNAME, #required
	 'pwd'	=> DB_SERVER_PASSWORD, #required
	 'db'	=> DB_DATABASE, #optional, default DB
	 'host'	=> DB_SERVER, #optional
	 'port'	=> '', #optional
...
<input type="submit" value=" Apply "><input type="button" value=" Cancel " onclick="window.location='<?php echo $self?>?XSS=<?php echo $_SESSION['XSS']; ?>'">
</div>
</center>
<?php
 print_footer();
