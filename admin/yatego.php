				...
				<tr>
					...
					<td class="boxCenter" width="100%" valign="top">
						<table border="0" width="100%" cellspacing="0" cellpadding="0">
							<tr>
								<td>
									<div class="pageHeading" style="background-image:url(images/gm_icons/gambio.png)">Yatego-Export</div>
									<br />
									<table border="0" width="100%" cellspacing="0" cellpadding="0">
										<tr>
													   ...
													   --------------------------------------------------------------*/
														if($_GET['section']=="selectArticles") 
														{
															...
															if(isset($_GET['selectCategoryArticles']) && isset($_GET['category']) && $_GET['category'] != 'all')
															{
																...
																{
																	$artsel->display(isset($_GET['page'])?$_GET['page']:0, $_GET['category'], 1);
																}
																if($_GET['selectCategoryArticles']=='no' ) 
																{
																	$artsel->display(isset($_GET['page'])?$_GET['page']:0, $_GET['category'], 2);
																}
															}
															else
															{
																...
																{
																	$artsel->display(isset($_GET['page'])?$_GET['page']:0, isset($_GET['category'])?$_GET['category']:'all');
																}
															}		
														}
														...
														{
															xtc_db_query("UPDATE configuration SET configuration_value='".$amount. "' WHERE configuration_key='YATEGO_TOPSELLER'");	
															return true;
														}
													?>												
												</div>
