...
<table border="0" width="100%" cellspacing="2" cellpadding="2">
	...
	<td class="boxCenter" width="100%" valign="top">
		<table border="0" width="100%" cellspacing="0" cellpadding="3">
			<tr>
				<td colspan="2">
					<div class="pageHeading" style="background-image:url(images/gm_icons/statistik.png)">&nbsp;<?php echo HEADING_TITLE; ?></div>
					<br />
				</td>
			</tr>
	<?php
			...
			<tr>
				<td colspan="2">
					<form action="" method="get">
						<table border="0" style="border: 1px solid; border-color: #cccccc;" width="100%" cellspacing="0" cellpadding="5">
							<tr>
...
?>
                ...
                <tr>
                  <td colspan="5" class="menuBoxHeading" align="left">
					&nbsp;
				</td>
				 </tr>
                <tr>
                ...
                <td valign="top">
                  <table border="0" width="100%" cellspacing="0" cellpadding="2">
                    <tr class="dataTableHeadingRow">
                      ...
                      <td class="dataTableHeadingContent" align="left"><?php echo TABLE_HEADING_ORDERS;?></td>
                      <td class="dataTableHeadingContent" align="left"><?php echo TABLE_HEADING_ITEMS; ?></td>
                      <td class="dataTableHeadingContent" align="left"><?php echo TABLE_HEADING_REVENUE;?></td>
                      <td class="dataTableHeadingContent" align="left"><?php echo  TABLE_HEADING_SHIPPING;?></td>
                    </tr>
<?php
...
<?php
    switch ($srView) {
      case '3':
?>
                      <td class="dataTableContent" align="left"><?php echo xtc_date_long(date("Y-m-d\ H:i:s", $sr->showDate)) . " - " . xtc_date_short(date("Y-m-d\ H:i:s", $sr->showDateEnd)); ?></td>
<?php
        break;
      case '4':
?>
                      <td class="dataTableContent" align="left"><?php echo xtc_date_long(date("Y-m-d\ H:i:s", $sr->showDate)); ?></td>
<?php
        break;
      default;
?>
                      <td class="dataTableContent" align="left"><?php echo xtc_date_short(date("Y-m-d\ H:i:s", $sr->showDate)) . " - " . xtc_date_short(date("Y-m-d\ H:i:s", $sr->showDateEnd)); ?></td>
<?php
    }
?>
                      <td class="dataTableContent" align="left"><?php echo $info[0]['order']; ?></td>
                      <td class="dataTableContent" align="left"><?php echo $info[$last - 1]['totitem']; ?></td>
                      <td class="dataTableContent" align="left"><?php echo $currencies->format($info[$last - 1]['totsum']);?></td>
                      <td class="dataTableContent" align="left"><?php echo $currencies->format($info[0]['shipping']);?></td>
                    </tr>
<?php
  } else {
    // csv export
...
<?php
          if ($srDetail == 2) {?>
                    <td class="dataTableContent" align="left"><?php echo $currencies->format($info[$i]['psum']); ?></td>
<?php
          } else { ?>
                    <td class="dataTableContent">&nbsp;</td>
<?php
