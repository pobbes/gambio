...
$iName = mysql_fetch_object($interkurier);
if (strcmp($iName->orders_status_name,'Expressversand freigegeben') == 0){
	...
	if (!$fp) {
		...
		$ot = mysql_fetch_object($order_total);
