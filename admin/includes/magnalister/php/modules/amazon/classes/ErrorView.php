 ...
 *
 * -----------------------------------------------------------------------------
 * $Id: ErrorView.php 1455 2011-12-18 11:58:02Z derpapst $
 *
	...
	public function __construct($settings = array()) {
		...
		$begin = MagnaDB::gi()->fetchOne('
		  ...
		  ORDER BY dateadded DESC 
		     LIMIT 1
		');
		$begin = getDBConfigValue('amazon.errorlog.lastdate', $_MagnaSession['mpID'], $begin);
		$begin = gmdate('Y-m-d H:i:s', strtotime((($begin === false) ? '1970-01-01' : $begin).' +0000') + 1);
		...
		if (!empty($newbegin)) {
			setDBConfigValue('amazon.errorlog.lastdate', $_MagnaSession['mpID'], $begin, true);
		}
