 ...
 *
 * -----------------------------------------------------------------------------
 * $Id: YategoInventoryView.php 1177 2011-08-01 15:52:44Z derpapst $
 *
...
class YategoInventoryView extends InventoryView {
	...
	public function __construct($settings = array()) {
		...
		if (isset($_POST['refreshStock'])) {
			require_once(DIR_MAGNALISTER_MODULES.'yatego/yategoFunctions.php');
			@set_time_limit(600);
			autoupdateYategoInventory($this->magnasession['mpID']);
		}
	}
