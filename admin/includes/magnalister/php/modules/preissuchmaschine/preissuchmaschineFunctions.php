...
function updatePreissuchmaschineInventoryByEdit($mpID, $updateData) {
	...
	try {
		$result = MagnaConnector::gi()->submitRequest(array(
			...
			'SEARCHENGINE' => 'preissuchmaschine',
			'MARKETPLACEID' => $mpID,
...
function autoupdatePreissuchmaschineInventory($mpID, $offset = 0, $limit = 100) {
	return autoupdateGenericInventory($mpID, $offset, $limit);
}
