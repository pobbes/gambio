 ...
 *
 * -----------------------------------------------------------------------------
 * $Id: meinpaketFunctions.php 1258 2011-09-22 14:20:45Z derpapst $
 *
...
function autoupdateMeinpaketInventory($mpID, $offset = 0, $limit = 100) {
	autoupdateGenericInventory($mpID, $offset, $limit, 'magnaMeinpaketUpdateItems');
}
...
function updateMeinpaketInventoryByOrder($mpID, $boughtItems, $subRelQuant = true) {
	if (getDBConfigValue('meinpaket.stocksync.tomarketplace', $mpID, 'no') == 'no') {
		return;
	}
