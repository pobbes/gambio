 ...
 *
 * -----------------------------------------------------------------------------
 * $Id: hitmeisterConfig.php 1595 2012-03-25 00:01:28Z MaW $
 *
...
if (isset($_GET['kind']) && ($_GET['kind'] == 'ajax')) {
	...
	$cG->sortKeys(array(
		'access', 'checkin', 'itemdetails', 'stats', 'price', /*'shipping', 'stocksync', 'inventoryupdate', */ 'checkinstandards', 'import', 'mail'
	));
