 ...
 *
 * -----------------------------------------------------------------------------
 * $Id: config.php 1566 2012-02-23 01:26:20Z MaW $
 *
...
function loadMaranonCacheConfig($purge = false) {
	...
	if ($magnaConfig['maranon']['IsAccessAllowed'] != 'yes') {
		$deniedCounter = (int)getDBConfigValue('AccessDeniedCounter', 0, 0) + 1;
		setDBConfigValue('AccessDeniedCounter', 0, $deniedCounter, true);
		if ($deniedCounter > 10) {
			setDBConfigValue('CallbackAccessDenied', 0, true, true);
		}
		#echo var_dump_pre((bool)getDBConfigValue('CallbackAccessDenied', 0));
	} else {
		setDBConfigValue('AccessDeniedCounter', 0, 0, true);
		setDBConfigValue('CallbackAccessDenied', 0, false, true);
	}
