 ...
 *
 * -----------------------------------------------------------------------------
 * $Id: german.php 1603 2012-04-03 16:38:29Z MaW $
 *
...
define('ML_LABEL_COPYLEFT', 'Copyright &copy; 2010-2012 RedGecko GmbH. Alle Rechte vorbehalten.');
...
define('ML_LABEL_ACCOUNTING_NAME', 'Keditinstitut');
...
#define('ML_GENERIC_DELETED', 'Gel&ouml;scht');
...
define('ML_GENERIC_LISTINGS', 'Listings');
...
define('ML_GENERIC_TEXT_NO_PREPARED_PRODUCTS', 'Es sind noch keine Produkte vorbereitet worden. Bevor Sie Produkte hier hochladen k&ouml;nnen, m&uuml;ssen Sie diese unter dem Reiter "Produkte vorbereiten" bearbeiten.<br>
...
define('ML_EBAY_CONDITION_VERY_GOOD', 'Gebraucht, wie neu');
...
define('ML_EBAY_LABEL_USE_GALLERY_YES_NO', 'Galery-Bild &uuml;bertragen');
...
define('ML_EBAY_MAX_80_CHARS', 'Titel max. 80 Zeichen');
...
define('ML_EBAY_PRICE_CALCULATED', 'Preis f&uuml;r eBay (berechnet)');
define('ML_EBAY_YOUR_PRICE_IF_OTHER', 'Ihr eBay Preis<br />(falls anders)');
define('ML_EBAY_FREEZE_PRICE_TOOLTIP', 'Blau = Preis einfrieren (so da&szlig; es bei &Auml;nderungen im Shop nicht automatisch angepa&szlig;t wird)');
...
define('ML_EBAY_BUYITNOW_PRICE', 'Sofortkauf-Preis');
...
define('ML_EBAY_NOTE_VARIATIONS_ENABLED', 'Hinweis: F&uuml;r diese Kategorie werden Varianten hochgeladen, soweit erw&uuml;nscht (Konfig-Einstellung) und vorhanden.');
define('ML_EBAY_NOTE_VARIATIONS_DISABLED', 'Hinweis: F&uuml;r diese Kategorie sieht eBay keine Varianten vor, es wird nur der Stammartikel hochgeladen.');
...
define('ML_EBAY_CATEGORY_DESC', 'Die eBay-Kategorie');
