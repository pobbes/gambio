<?php
/* --------------------------------------------------------------
   new_category.php 2008-08-10 gambio
   Gambio OHG
   http://www.gambio.de
   ...
   --------------------------------------------------------------*/
	...
	<tr >
		<td>
			<div class="pageHeading" style="background-image:url(images/gm_icons/artkatalog.png)">
      ...
      <div style="width:49%;margin-right:10px;float:left;">
			...
			<table border="0" width="100%" cellspacing="3" cellpadding="3" class="gm_border dataTableRow">
				...
				<tr>
					...
					<td class="main" valign="top" align="left">
						<?php echo xtc_draw_pull_down_menu('products_sorting',$order_array,$cInfo->products_sorting); ?>
						<?php
							// BOF GM_MOD
							$order_array='';
		  ...
		  <table border="0" width="100%" cellspacing="3" cellpadding="3" class="gm_border dataTableRow">
			<tr>
			  <td class="main strong" valign="top" align="left">
				...
				<?php echo $coo_feature_helper->generate_feature_list($_GET['cID']); ?>
				</table>
      ...
      <table border="0" width="100%" cellspacing="3" cellpadding="3" class="gm_border dataTableRow">
        <tr>
            ...
            <input type="submit" name="save_features" value="speichern" class="button">
          </td>
        </tr>
      </table>
      </div>
      ...
      <table border="0" width="100%" cellspacing="3" cellpadding="3" class="gm_border dataTableRow">
			...
			<table border="0" width="100%" cellspacing="3" cellpadding="3" class="gm_border dataTableRow">
				...
				<!-- CATEGORIES-STATUSBAR-TEXT -->
				<tr>
					<td class="main strong" valign="top" align="left" width="150">
						<?php  echo GM_STATUSBAR_TEXT; ?>
					</td>
					<td class="main" valign="top" align="left">
						<?php echo xtc_image(DIR_WS_LANGUAGES.$languages[$i]['directory'].'/admin/images/'.$languages[$i]['image']); ?>&nbsp;
						<?php echo xtc_draw_input_field('gm_statusbar[' . $languages[$i]['id'] . ']', (($gm_statusbar[$languages[$i]['id']]) ? stripslashes($gm_statusbar[$languages[$i]['id']]) : $gmStatusbar->get_cat_statusbar($cInfo->categories_id, $languages[$i]['id'])),'size=50'); ?>
					</td>
				</tr>
			...
			<?php
				if ($cInfo->categories_icon) {
					$imagesize = @getimagesize(DIR_FS_CATALOG.'images/categories/icons/'.$cInfo->categories_icon);
			?>
				<tr>
					<td class="main strong" valign="top" align="left" width="150">
		  ...
		  <?php
            if ($cInfo->categories_image) {				
				$image_size = getimagesize(DIR_FS_CATALOG.'images/categories/'.$cInfo->categories_image);
            ?>
				<tr>
					<td class="main strong" valign="top" align="left" width="150">
						<?php echo TEXT_DELETE; ?>
			...
			?>
				...
				<tr>
					...
					<td class="main" valign="top" align="left">
						...
						<input class="button" type="button" value="<?php echo BUTTON_CANCEL; ?>" onclick="javascript:history.back()" style="float:right">
						...
						<!--<a class="button float_right" onClick="this.blur()" href="<?php echo xtc_href_link(FILENAME_CATEGORIES, 'cPath=' . $cPath . '&cID=' . $_GET['cID']) . '">' . BUTTON_CANCEL . '</a>'; ?>-->					
					</td>
				</tr>
			</table>
			</form>
