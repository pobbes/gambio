<?php
/* --------------------------------------------------------------
   paypal_capturetransaction.php 2008-05-04 gambio
   Gambio OHG
   http://www.gambio.de
...
<div class="highlightbox">
	<table border="0" width="100%" cellspacing="0" cellpadding="0">
		<tr>
			<td class="dataTableHeadingContent" style="border-right: 0px;">
				<?php echo TEXT_PAYPAL_CAPTURE_TRANSACTION; ?>
			</td>
		</tr>
	</table>
	...
	<table width="100%" border="0" class="gm_border dataTableRow">
		...
		<tr>
			<td class="main" nowrap="nowrap"><?php echo TEXT_PAYPAL_TRANSACTION_AMOUNT; ?></td>
			<td class="main"><?php echo xtc_draw_input_field('capture_amount',number_format((double)$ipn_data['mc_authorization']-$ipn_data['mc_captured'], 2, '.', ''),'size="10"'); ?></td>
		</tr>
		<tr>
	...
	<input type="submit" class="button float_left" value="<?php echo TEXT_PAYPAL_BUTTON_CAPTURE; ?>">
