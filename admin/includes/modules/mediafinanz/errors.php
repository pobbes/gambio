...
<td class="boxCenter" width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td class="pageHeading">mediafinanz - Fehler&uuml;bersicht</td>
          ...
          <tr>
            ...
            if (count($errors) > 0)
            {
                ?>
                     ...
                     <tr><td colspan="3"><a href="mediafinanz.php?action=errors&emptyTable=true">Fehlertabelle leeren</a></td></tr>
                      <tr bgcolor="white">
                        <td>Datum</td>
                        <td>Kunde</td>
                        <td>Fehler</td>
            ...
            {
                echo 'Es liegen keine Fehler vor!';
            }
            ?>
