...
class MF_Suspect
{
    ...
    public static function createSuspect($customerId)
    {
        ...
        $subjectErg = mysql_fetch_assoc($subjectQuery);

        if ($subjectErg)
        {
            //suspect found!
            $address = new MF_Address($subjectErg['entry_street_address'],
                                      $subjectErg['entry_city'],
                                      $subjectErg['entry_postcode'],
                                      $subjectErg['country']);

            $suspect = new MF_Suspect($customerId,
                                      $subjectErg['entry_company'],
                                      $subjectErg['sex'],
                                      $subjectErg['entry_firstname'],
                                      $subjectErg['entry_lastname'],
                                      $subjectErg['email'],
                                      $subjectErg['phone'],
                                      $subjectErg['customers_vat_id'],
                                      $address,
