...
try
{
    $result = $encashment->closeClaim($fileNumber);
}
catch (Exception $e)
{
      ...
      <tr>
        ...
        <table border="0" cellspacing="0" cellpadding="2">
          <tr>
            ...
            if ($result === true)
            {
                echo 'Forderung storniert!';
            }
            else
            {
                echo 'Fehler beim Stornieren der Forderung!';
          ...
          <tr>
              <td>
                  <a href=<?php echo'"mediafinanz.php?action=display_claim&oID='.$_POST['orderId'].'"'; ?>>Zur&uuml;ck</a>
              </td>
          </tr>
        </table></td>
      </tr>
