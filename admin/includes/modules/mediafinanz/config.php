...
$string =  '<td class="boxCenter" width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td class="pageHeading">mediafinanz</td>
         ...
         <form action="mediafinanz.php?action=config" method="POST" name="mediafinanz">
            <tr>
               <td colspan="2">
                 <div>
                         <ul id="navlist">
                                 <li><a href="mediafinanz.php?action=config&options=general" id="configinactive">Allgemeine Optionen</a></li>
                                 <li><a href="mediafinanz.php?action=config&options=claim" id="configinactive">Forderungs Optionen</a></li>
                                 <li><a href="mediafinanz.php?action=config&options=score" id="configinactive">Allg. Bonitäts Optionen</a></li>
                                 <li><a href="mediafinanz.php?action=config&options=score_person" id="configinactive">Personen Bonitäts Optionen</a></li>
                                 <li><a href="mediafinanz.php?action=config&options=score_company" id="configinactive">Firmen Bonitäts Optionen</a></li>
                         </ul>
                 </div>
               </td>
            </tr>';
