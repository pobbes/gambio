<?php
/* --------------------------------------------------------------
   cross_selling.php 2008-07-28 gambio
   Gambio OHG
   http://www.gambio.de
...
?>
    <table width="100%" cellspacing="0" cellpadding="2">
      <tr>
        <td>
			<div class="pageHeading" style="background-image:url(images/gm_icons/artkatalog.png)"><?php echo CROSS_SELLING.' : '.$article_data['products_name']; ?></div>
		</td>
      </tr>
      <tr>
...
?>
  <tr>
    <td class="gm_strong categories_view_data" colspan="6"><?php echo GM_TITLE_NO_ENTRY; ?></td>
  </tr>
<?php
...
if (defined('YOOCHOOSE_ACTIVE') && YOOCHOOSE_ACTIVE) {
  require_once('../includes/yoochoose/recommendations.php');
  require_once('../includes/yoochoose/functions.php');
  require_once('../includes/classes/product.php');
?>
<tr>
  <td>
    <br />
    <div class="pageHeading" style="background-image:url(images/gm_icons/artkatalog.png)"><?php echo YOOCHOOSE_CROSS_SELL_RECOMMENDATION; ?></div>
...
?>
              <tr>
                <td class="categories_view_data"><input type="checkbox" name="ids[]" value="<?php echo $data['products_id']; ?>"></td>
                <td class="categories_view_data" style="text-align: left;"><?php echo xtc_draw_pull_down_menu('group_name[' . $data['products_id'] . ']', $cross_sell_groups); ?></td>
                <td class="categories_view_data" style="text-align: left;"><?php echo $data['products_model']; ?>&nbsp;</td>
                <td class="categories_view_data" style="text-align: left;"><?php echo $data['products_name']; ?>&nbsp;</td>
                <td class="categories_view_data" style="text-align: left;"><?php echo buildCAT($categorie_data['categories_id']); ?>&nbsp;</td>
              </tr>
<?php
           }
...
<td>
<br />
<div class="pageHeading" style="background-image:url(images/gm_icons/artkatalog.png)"><?php echo CROSS_SELLING_SEARCH; ?></div>
 <table width="100%" border="0" cellspacing="0" cellpadding="2"  class="gm_border dataTableRow">
<tr >
<?php
	...
	echo xtc_draw_hidden_field('cpath', $_GET['cpath']);
?>
<td class="" width="40"><?php echo xtc_draw_input_field('search', '', 'style="font-size: 14px; height: 25px; float: left; margin-right: 5px;"');?></td>
<td><?php
