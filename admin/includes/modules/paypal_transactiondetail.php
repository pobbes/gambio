...
?>
 ...
 <div>
   ...
   <?php if (isset($ipn_id)) { ?>
	...
	<table width="100%" border="0" class="gm_border dataTableRow">
		<tr>
		  <td class="main" width="10%"><?php echo  xtc_image(DIR_WS_ICONS . 'icon_refund.gif'); ?></td>
   ...
   <?php if ($ipn_data['pending_reason']=='authorization' || $ipn_data['pending_reason']=='order') { ?>
		   <tr>
			  <td class="main" width="10%"><?php echo  xtc_image(DIR_WS_ICONS . 'icon_capture.gif'); ?></td>
		   ...
		   <tr>
			  <td class="main" width="10%"><?php echo  xtc_image(DIR_WS_ICONS . 'exclamation.png'); ?></td>
