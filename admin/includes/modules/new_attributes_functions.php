...
defined('_VALID_XTC') or die('Direct Access to this location is not allowed.');
  ...
  function checkAttribute($current_value_id, $current_pid, $current_product_option_id) {
    // BOF GM_MOD:
    global $attribute_value_price,$sortorder, $attribute_value_weight, $attribute_value_weight_prefix, $attribute_value_prefix, $attribute_value_model, $attribute_value_stock, $posCheck, $negCheck, $posCheck_weight, $negCheck_weight,$attribute_value_download_count, $attribute_value_download_expire,$attribute_value_download_filename,$gm_attribute_vpe_id,$gm_attribute_vpe_value,$gm_attribute_ean;
    ...
    if ($isFound) {
      while($line = xtc_db_fetch_array($result)) {
        ...
        // BOF GM_MOD
        $gm_attribute_vpe_id = $line['products_vpe_id'];
        $gm_attribute_vpe_value = $line['gm_vpe_value'];
        $gm_attribute_ean = $line['gm_ean'];
        // EOF GM_MOD
