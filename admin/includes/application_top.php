<?php
/* --------------------------------------------------------------
   application_top.php 2012-06-12 gm
   Gambio GmbH
   http://www.gambio.de
...
if(file_exists(str_replace('\\', '/', dirname(dirname(dirname(__FILE__)))) . '/GProtector'))
{
	require_once(str_replace('\\', '/', dirname(dirname(dirname(__FILE__)))) . '/GProtector/start.inc.php');
}
...
// BOF Gambio Box
define('FILENAME_GM_EBAY', 'gm_ebay.php');
...
define('FILENAME_GM_STATUSBAR', 'gm_statusbar.php');
...
define('FILENAME_GM_TRUSTED_INFO', 'gm_trusted_info.php');
define('FILENAME_GM_TRUSTED_SHOP_ID', 'gm_trusted_shop_id.php');
define('FILENAME_GM_TRUSTED_SHOPS_WIDGET', 'gm_trusted_shops_widget.php');
