<?php
/* --------------------------------------------------------------
   gm_invoicing.php 2011-03-28 gambio
   Gambio OHG
   http://www.gambio.de
   ...
   --------------------------------------------------------------*/
	...
	require_once(DIR_FS_ADMIN . 'gm/classes/GMInvoicingConfiguration.php');
	require_once(DIR_FS_ADMIN . 'gm/classes/GMInvoicing.php');	
				...
				<tr>
					...
					<td class="boxCenter" width="100%" valign="top">
						<table border="0" width="100%" cellspacing="0" cellpadding="0">
							<tr>
								<td>
									<div class="pageHeading" style="background-image:url(images/gm_icons/gambio.png)"><?php echo GM_INVOICING_EXPORT; ?></div>
									<br />
									<table border="0" width="100%" cellspacing="0" cellpadding="0">
										<tr>
