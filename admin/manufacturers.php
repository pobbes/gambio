<?php
/* --------------------------------------------------------------
   manufacturers.php 2009-05-22 gambio
   Gambio OHG
   http://www.gambio.de
...
<?php
  ...
  switch ($_GET['action']) {
    case 'new':
      ...
      $contents[] = array('text' => '<br />' . TEXT_MANUFACTURERS_IMAGE . '<br />' . xtc_draw_file_field('manufacturers_image', false, 10));
      ...
      $contents[] = array('align' => 'center', 'text' => '<br /><div align="center">' . xtc_button(BUTTON_SAVE) . '' . xtc_button_link(BUTTON_CANCEL, xtc_href_link(FILENAME_MANUFACTURERS, 'page=' . $_GET['page'] . '&mID=' . $_GET['mID'])) . '</div>');
	  break;
    ...
    case 'edit':
      ...
      $contents[] = array('text' => '<br />' . TEXT_MANUFACTURERS_IMAGE . '<br />' . xtc_draw_file_field('manufacturers_image', false, 10) . '<br />' . $mInfo->manufacturers_image);
      ...
      $contents[] = array('text' => '<br />' . TEXT_MANUFACTURERS_URL . $manufacturer_inputs_string);
      $contents[] = array('align' => 'center', 'text' => '<br /><div align="center">' . xtc_button(BUTTON_SAVE) . '' . xtc_button_link(BUTTON_CANCEL, xtc_href_link(FILENAME_MANUFACTURERS, 'page=' . $_GET['page'] . '&mID=' . $mInfo->manufacturers_id)) . '</div>');
      break;
    ...
    case 'delete':
      ...
      $contents[] = array('align' => 'center', 'text' => '<br /><div align="center">' . xtc_button(BUTTON_DELETE) . '' . xtc_button_link(BUTTON_CANCEL, xtc_href_link(FILENAME_MANUFACTURERS, 'page=' . $_GET['page'] . '&mID=' . $mInfo->manufacturers_id)) . '</div>');
    ...
    default:
      if (is_object($mInfo)) {
        ...
        $contents[] = array('align' => 'center', 'text' => '<div align="center">' . xtc_button_link(BUTTON_EDIT, xtc_href_link(FILENAME_MANUFACTURERS, 'page=' . $_GET['page'] . '&mID=' . $mInfo->manufacturers_id . '&action=edit')) . '' . xtc_button_link(BUTTON_DELETE, xtc_href_link(FILENAME_MANUFACTURERS, 'page=' . $_GET['page'] . '&mID=' . $mInfo->manufacturers_id . '&action=delete')) . '</div>');
