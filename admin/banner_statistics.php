<?php
/* --------------------------------------------------------------
   banner_statistics.php 2011-06-06 gambio
   Gambio GmbH
   http://www.gambio.de
...
<!-- body_text //-->
    <td class="boxCenter" width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
      ...
      <tr>
        <td align="center" class="gm_border dataTableRow">
<?php
  if ( (function_exists('imagecreate')) && ($dir_ok) && ($banner_extension) ) {
    ...
    switch ($_GET['type']) {
      case 'yearly':
        ...
        echo xtc_image(DIR_WS_CATALOG  . 'cache/banner_yearly-' . $banner_id . '-' . FileLog::get_secure_token() . '.' . $banner_extension);
        break;
      case 'monthly':
        include(DIR_WS_INCLUDES . 'graphs/banner_monthly.php');
        echo xtc_image(DIR_WS_CATALOG  . 'cache/banner_monthly-' . $banner_id . '-' . FileLog::get_secure_token() . '.' . $banner_extension);
        break;
      default:
      case 'daily':
        include(DIR_WS_INCLUDES . 'graphs/banner_daily.php');
        echo xtc_image(DIR_WS_CATALOG  . 'cache/banner_daily-' . $banner_id . '-' . FileLog::get_secure_token() . '.' . $banner_extension);
        break;
    }
?>
