	...
	switch ($_GET['action']) {
		...
		case 'import':
			if($_POST['gm_delete_products'] == '1'){
				...
				@mysql_query("TRUNCATE personal_offers_by_customers_status_");
				@mysql_query("TRUNCATE personal_offers_by_customers_status_1");
				@mysql_query("TRUNCATE personal_offers_by_customers_status_2");
				@mysql_query("TRUNCATE personal_offers_by_customers_status_3");
				@mysql_query("TRUNCATE personal_offers_by_customers_status_4");
				@mysql_query("TRUNCATE personal_offers_by_customers_status_5");
				@mysql_query("TRUNCATE personal_offers_by_customers_status_6");
				@mysql_query("TRUNCATE personal_offers_by_customers_status_7");
				@mysql_query("TRUNCATE personal_offers_by_customers_status_8");
				@mysql_query("TRUNCATE personal_offers_by_customers_status_9");
				@mysql_query("TRUNCATE personal_offers_by_customers_status_10");
			...
			@mysql_query("OPTIMIZE TABLE personal_offers_by_customers_status_");
			@mysql_query("OPTIMIZE TABLE personal_offers_by_customers_status_1");
			@mysql_query("OPTIMIZE TABLE personal_offers_by_customers_status_2");
			@mysql_query("OPTIMIZE TABLE personal_offers_by_customers_status_3");
			@mysql_query("OPTIMIZE TABLE personal_offers_by_customers_status_4");
			@mysql_query("OPTIMIZE TABLE personal_offers_by_customers_status_5");
			@mysql_query("OPTIMIZE TABLE personal_offers_by_customers_status_6");
			@mysql_query("OPTIMIZE TABLE personal_offers_by_customers_status_7");
			@mysql_query("OPTIMIZE TABLE personal_offers_by_customers_status_8");
			@mysql_query("OPTIMIZE TABLE personal_offers_by_customers_status_9");
			@mysql_query("OPTIMIZE TABLE personal_offers_by_customers_status_10");
				...
				<td class="boxCenter" width="100%" valign="top">
					<table border="0" width="100%" cellspacing="0" cellpadding="0">
						<tr>
							<td>
								<!-- gm_module //-->
								<div class="pageHeading" style="background-image:url(images/gm_icons/hilfsprogr1.png)"><?php echo BOX_IMPORT; ?></div>
								<br />									
