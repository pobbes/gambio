...
/* 
	--------------------------------------------------------------
	gm_opensearch.php 08.04.2008 pt@gambio
	Gambio OHG
	http://www.gambio.de
									...
									<table border="0" width="100%" cellspacing="0" cellpadding="0">
										<tr>
											<td width="120" class="dataTableHeadingContent">
												<a href="<?php echo xtc_href_link('gm_opensearch.php', 'action=gm_opensearch'); ?>"><?php echo TITLE_GM_OPENSEARCH; ?></a>
												</td>
											<td class="dataTableHeadingContent"  style="border-right: 0px;">
												<a href="<?php echo xtc_href_link('gm_opensearch.php', 'action=gm_opensearch_conf'); ?>"><?php echo TITLE_GM_OPENSEARCH_CONF; ?></a>
											</td>
										</tr>
									</table>
									<table border="0" width="100%" cellspacing="0" cellpadding="0" class="gm_border dataTableRow">
										<tr>
											<td valign="top" class="main">												
												...
												<?php include(DIR_FS_ADMIN . 'gm_opensearch_action.php'); ?>
												</div>
											</td>
										</tr>
									</table>
