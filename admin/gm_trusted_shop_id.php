...
/* 
   ...
   --------------------------------------------------------------*/
	...
	if(isset($_POST['gm_submit'])) 
	{
		...
		{
			$msg = '<font color=red><strong>Die eingegebene Shop-ID ist ungültig.</strong></font>';
		} 
		else
		{
			$msg = '
				...
				- das Trusted Shops Gütesiegels in der Menübox "Trusted Shops"<br>
				- die Anmeldung zur Geld-zurück-Garantie in der Bestellbestätigungsseite
			';
			mysql_query('
