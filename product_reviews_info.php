<?php
/* --------------------------------------------------------------
   product_reviews_info.php 2008-08-08 gambio
   Gambio OHG
   http://www.gambio.de
...
$smarty->assign('BUTTON_BACK_LINK', xtc_href_link(FILENAME_PRODUCT_REVIEWS, $get_params));
...
$smarty->assign('BUTTON_BUY_NOW_URL', xtc_href_link(FILENAME_DEFAULT, 'action=buy_now&BUYproducts_id=' . $reviews['products_id']));
$smarty->assign('IMAGE', xtc_image(DIR_WS_THUMBNAIL_IMAGES.$reviews['products_image'], $reviews['products_name'], '', '', 'hspace="5" vspace="5"'));
$smarty->assign('IMAGE_URL', DIR_WS_THUMBNAIL_IMAGES . basename($reviews['products_image']));
