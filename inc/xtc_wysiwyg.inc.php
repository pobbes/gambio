<?php
/* --------------------------------------------------------------
   xtc_wysiwyg.inc.php 2008-08-10 gambio
   Gambio OHG
   http://www.gambio.de
...
$image_path = '&Type=images';
	...
	switch($type) {
                ...
                case 'gv_mail':
                        ...
                        break;
								// BOF GM_MOD email templates editor
								// WYSIWYG editor products_description textarea named products_description_langID
                case 'gm_emails':
                        $val ='var oFCKeditor = new FCKeditor( \'gm_emails_content\', \'800\', \'400\'  ) ;
                        	   oFCKeditor.BasePath = "'.$path.'" ;
                        	   oFCKeditor.Config["LinkBrowserURL"] = "'.$filemanager.$file_path.'" ;
                        	   oFCKeditor.Config["ImageBrowserURL"] = "'.$filemanager.$image_path.'" ;
                        	   oFCKeditor.Config["AutoDetectLanguage"] = false ;
                        	   ...
                        	   ';
                        break;
								// EOF GM_MOD email templates editor
    }
