<?php
/* --------------------------------------------------------------
   banktransfer_validation.php 2008-07-21 gambio
   Gambio GmbH
   http://www.gambio.de
...
////
  ...
  function Method00($AccountNo, $Significance, $Checkpoint, $Modulator=10, $LeaveCheckpoint=0, $DoNotExpand=0, $ChecksumCalcMethod = '') {
    $Help = 0;
    $Method00 = 1;
