 ...
 class main_ORIGIN {
	...
	function gm_get_shipping_link($p_lightbox = false) {
		...
		if($gmSEOBoost->boost_content && $p_lightbox == false) {
			...
			$gm_shipping_link = xtc_href_link(FILENAME_POPUP_CONTENT, 'coID='.$row['content_group'].$t_lightbox_get_param.$SEF_parameter);
		}
