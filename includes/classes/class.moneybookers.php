<?php
/* --------------------------------------------------------------
   class.moneybookers.php 2011-04-12 gm
   Gambio GmbH
   http://www.gambio.de
...
//		$process_button_string = 
		...
		'platform'=> '21477218',
		'status_url2'=> _PAYMENT_MONEYBOOKERS_EMAILID,
	...
	function payment_action() {
		xtc_redirect(xtc_href_link('moneybookers_iframe.php', '', 'SSL'));
	}
