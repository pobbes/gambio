<?php
/* --------------------------------------------------------------
   vat_validation.php 2012-05-10 gm
   Gambio GmbH
   http://www.gambio.de
...
class vat_validation_ORIGIN {
	...
	function vat_validation_ORIGIN($vat_id = '', $customers_id = '', $customers_status = '', $country_id = '', $guest = false) {
		$this->vat_info = array ();
	...
	function checkVatID_EU($vat_id, $country_id) {
		...
		$coo_soap_client = new nusoap_client('http://ec.europa.eu/taxation_customs/vies/checkVatService.wsdl', true);
