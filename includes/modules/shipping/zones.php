 ...
 */
    function quote($method = '') {
      ...
      if ($error == true) $this->quotes['error'] = MODULE_SHIPPING_ZONES_UNDEFINED_RATE;
    ...
    function install() {
      ...
      xtc_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_key, configuration_value, configuration_group_id, sort_order, set_function, date_added) VALUES ('MODULE_SHIPPING_ZONES_STATUS', 'True', '6', '0', 'gm_cfg_select_option(array(\'True\', \'False\'), ', now())");
...
MainFactory::load_origin_class('zones');
?>