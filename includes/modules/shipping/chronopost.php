...
/* -----------------------------------------------------------------------------------------
  ...
  class chronopost_ORIGIN {
    var $code, $title, $description, $enabled, $num_chronopost;

/**
 * class constructor
 */
    function chronopost_ORIGIN() {
 ...
 */
    ...
    function install() {
      xtc_db_query("insert into " . TABLE_CONFIGURATION . " ( configuration_key, configuration_value,  configuration_group_id, sort_order, date_added) VALUES ('MODULE_SHIPPING_CHRONOPOST_STATUS', 'True', '6', 'gm_cfg_select_option(array(\'True\', \'False\'), ', now())");
...
MainFactory::load_origin_class('chronopost');
?>