  ...
  class ot_cod_fee_ORIGIN {
    ...
    function process() {
      ...
      if (MODULE_ORDER_TOTAL_COD_FEE_STATUS == 'true') {
		...
		// module DPD
		if ($_SESSION['shipping']['id'] == 'dpd_dpd') $cod_zones = preg_split('/[:,]/', MODULE_ORDER_TOTAL_COD_FEE_DPD);		
		// module FEDEXEU
		if ($_SESSION['shipping']['id'] == 'fedexeu_fedexeu') $cod_zones = preg_split('/[:,]/', MODULE_ORDER_TOTAL_COD_FEE_FEDEXEU); 	
		// module FLAT
		...
		// module GAMBIOULTRA
		if ($_SESSION['shipping']['id'] == 'gambioultra_gambioultra') $cod_zones = preg_split('/[:,]/', MODULE_ORDER_TOTAL_COD_FEE_GAMBIOULTRA);
		// module ITEM		
		if ($_SESSION['shipping']['id'] == 'item_item') $cod_zones = preg_split('/[:,]/', MODULE_ORDER_TOTAL_COD_FEE_ITEM);
		// module SELFPICKUP
		if ($_SESSION['shipping']['id'] == 'selfpickup_selfpickup') $cod_zones = preg_split('/[:,]/', MODULE_ORDER_TOTAL_COD_FEE_SELFPICKUP);
		// module TABLE
		...
		if ($_SESSION['shipping']['id'] == 'zonese_zonese') $cod_zones = preg_split('/[:,]/', MODULE_ORDER_TOTAL_COD_FEE_ZONESE);
...
//                                  'value' => '');
    ...
    function keys() {
      ...
      return array(
					...
					'MODULE_ORDER_TOTAL_COD_FEE_ZONESE',					
    ...
    function install() {
      ...
      xtc_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_key, configuration_value, configuration_group_id, sort_order, date_added) values ('MODULE_ORDER_TOTAL_COD_FEE_FEDEXEU', 'DE:4.00,00:9.99', '6', '0', now())");
      ...
      xtc_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_key, configuration_value, configuration_group_id, sort_order, date_added) values ('MODULE_ORDER_TOTAL_COD_FEE_GAMBIOULTRA', 'DE:4.00,00:9.99', '6', '0', now())");
      ...
      xtc_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_key, configuration_value, configuration_group_id, sort_order, date_added) values ('MODULE_ORDER_TOTAL_COD_FEE_SELFPICKUP', 'DE:4.00,00:9.99', '6', '0', now())");
      ...
      xtc_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_key, configuration_value, configuration_group_id, sort_order, date_added) values ('MODULE_ORDER_TOTAL_COD_FEE_ZONESE', 'DE:4.00,00:9.99', '6', '0', now())");
