...
class CYExportYatego {
	...
	function CYExportYatego($mode) {
		...
		if(mysql_num_rows(mysql_query("SHOW COLUMNS FROM products LIKE 'products_ean'")) > 0)
		{
   ...
   * Zeilenumbruch \r\n
   --------------------------------------------------------------*/
	function exportArticles() {
		...
		while($articleLine = mysql_fetch_assoc($result)) {
   ...
   * Zeilenumbruch \r\n
   --------------------------------------------------------------*/
	function exportVariantSets() {
		...
		while($variantSetsLine = mysql_fetch_assoc($result)) {
   ...
   * Zeilenumbruch \r\n
   --------------------------------------------------------------*/
	function exportVariants() {
		...
		$this->dataOutput("\r\n");
		while($variantsLine = mysql_fetch_assoc($result)) {
   ...
   * Zeilenumbruch \r\n
   --------------------------------------------------------------*/
	function exportCategories() {
		...
		$this->dataOutput("\r\n");
		while($categoriesLine = mysql_fetch_assoc($result)) {
   ...
   * Zeilenumbruch \r\n
   --------------------------------------------------------------*/
	function exportStocks() {
		...
		$this->dataOutput("\r\n");
		while($stocksLine = mysql_fetch_assoc($result)) {
   ...
   * Zeilenumbruch \r\n
   --------------------------------------------------------------*/
	function exportDiscountSets() {
		...
		while($discountSetsLine = mysql_fetch_assoc($result)) {
   ...
   * Zeilenumbruch \r\n
   --------------------------------------------------------------*/
	function exportDiscounts() {
		...
		$this->dataOutput("delitem\r\n");
		while($discountsLine = mysql_fetch_assoc($result)) {
