<?php
/* -----------------------------------------------------------------------------------------
   $Id: skrill_elv.php 39 2009-01-22 15:44:52Z mzanier $
...
class skrill_elv_ORIGIN extends fcnt_skrill {

	var $images='ec.gif';

	// class constructor
	function skrill_elv_ORIGIN() {
...
MainFactory::load_origin_class('skrill_elv');
?>
