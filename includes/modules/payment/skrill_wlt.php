<?php
/* -----------------------------------------------------------------------------------------
   $Id: skrill_wlt.php 39 2009-01-22 15:44:52Z mzanier $
...
class skrill_wlt_ORIGIN extends fcnt_skrill {

	var $images='by_ewallet_90x45.gif';

	// class constructor
	function skrill_wlt_ORIGIN() {
...
MainFactory::load_origin_class('skrill_wlt');
?>
