<?php
/* -----------------------------------------------------------------------------------------
   $Id: skrill_pwy.php 39 2009-01-22 15:44:52Z mzanier $
...
class skrill_pwy_ORIGIN extends fcnt_skrill {

	var $images='p24.gif';

	// class constructor
	function skrill_pwy_ORIGIN() {
...
MainFactory::load_origin_class('skrill_pwy');
?>
