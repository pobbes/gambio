<?php
/* -----------------------------------------------------------------------------------------
   $Id: skrill_csi.php 39 2009-01-22 15:44:52Z mzanier $
...
class skrill_csi_ORIGIN extends fcnt_skrill {

	var $images='cartasi.gif';

	// class constructor
	function skrill_csi_ORIGIN() {
...
MainFactory::load_origin_class('skrill_csi');
?>
