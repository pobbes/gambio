...
class hpeps_ORIGIN {
  ...
  function install() /*{{{*/
  {
    ...
    $inst[] = array(
      ...
      'configuration_value'     => '31HA07BC812125981B4F52033DE486AB',
    );
    $inst[] = array(
  ...
  {
		return array (
			'MODULE_PAYMENT_HPEPS_STATUS',
      'MODULE_PAYMENT_HPEPS_SECURITY_SENDER',
      'MODULE_PAYMENT_HPEPS_USER_LOGIN',
      'MODULE_PAYMENT_HPEPS_USER_PWD',
      'MODULE_PAYMENT_HPEPS_TRANSACTION_CHANNEL',
      'MODULE_PAYMENT_HPEPS_TRANSACTION_MODE',
      'MODULE_PAYMENT_HPEPS_TEST_ACCOUNT',
			'MODULE_PAYMENT_HPEPS_PROCESSED_STATUS_ID',
			'MODULE_PAYMENT_HPEPS_PENDING_STATUS_ID',
			'MODULE_PAYMENT_HPEPS_CANCELED_STATUS_ID',
			'MODULE_PAYMENT_HPEPS_NEWORDER_STATUS_ID',
			'MODULE_PAYMENT_HPEPS_SORT_ORDER',
			'MODULE_PAYMENT_HPEPS_ALLOWED',
      'MODULE_PAYMENT_HPEPS_ZONE',
      #'MODULE_PAYMENT_HPEPS_',
		);
	}/*}}}*/

}

MainFactory::load_origin_class('hpeps');
?>