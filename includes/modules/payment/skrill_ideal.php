<?php
/* -----------------------------------------------------------------------------------------
   $Id: skrill_ideal.php 39 2009-01-22 15:44:52Z mzanier $
...
class skrill_ideal_ORIGIN extends fcnt_skrill {

	var $images='ideal.gif';

	// class constructor
	function skrill_ideal_ORIGIN() {
...
MainFactory::load_origin_class('skrill_ideal');
?>
