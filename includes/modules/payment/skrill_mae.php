<?php
/* -----------------------------------------------------------------------------------------
   $Id: skrill_mae.php 39 2009-01-22 15:44:52Z mzanier $
...
class skrill_mae_ORIGIN extends fcnt_skrill {

	var $images='maestro.gif';

	// class constructor
	function skrill_mae_ORIGIN() {
...
MainFactory::load_origin_class('skrill_mae');
?>
