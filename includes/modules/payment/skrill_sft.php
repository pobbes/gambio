<?php
/* -----------------------------------------------------------------------------------------
   $Id: skrill_sft.php 39 2009-01-22 15:44:52Z mzanier $
    ...
    * 2.2 new modules
    * 2.3 updates
    * 2.4 major update, iframe skrill
...
class skrill_sft_ORIGIN extends fcnt_skrill {

	var $images='sofort.gif';

	// class constructor
	function skrill_sft_ORIGIN() {
...
MainFactory::load_origin_class('skrill_sft');
?>
