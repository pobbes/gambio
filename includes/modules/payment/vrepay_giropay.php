...
class vrepay_giropay_ORIGIN {

	// class constructor
	function vrepay_giropay_ORIGIN() {
	...
	function install() {
		...
		xtc_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_key, configuration_value, configuration_group_id, sort_order, date_added) values ('MODULE_PAYMENT_VREPAY_GIROPAY_VERWENDUNG2', 'enjoy shopping', '6', '10', now())");
...
MainFactory::load_origin_class('vrepay_giropay');
?>