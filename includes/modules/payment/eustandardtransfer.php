<?php
/* --------------------------------------------------------------
   eustandardtransfer.php 2009-04-24 mb
   Gambio OHG
   http://www.gambio.de
...
class eustandardtransfer_ORIGIN {
	...
	// class constructor
	function eustandardtransfer_ORIGIN() {
	...
	function install() {
		...
		xtc_db_query("insert into ".TABLE_CONFIGURATION." (configuration_key, configuration_value,configuration_group_id, sort_order, set_function, date_added) values ('MODULE_PAYMENT_EUTRANSFER_STATUS', 'True', '6', '3', 'gm_cfg_select_option(array(\'True\', \'False\'), ', now());");
