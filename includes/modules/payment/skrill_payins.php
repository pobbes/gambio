<?php
/* -----------------------------------------------------------------------------------------
   $Id: skrill_payins.php 39 2009-01-22 15:44:52Z mzanier $
...
class skrill_payins_ORIGIN extends fcnt_skrill {

	var $images='Skrill-whitelabel-ratenkauf-78x26-white.png'; // 'by_ewallet_90x45.gif';

	// class constructor
	function skrill_payins_ORIGIN() {
		global $order, $language;

		$this->_setCode('payins','PAY');
		$this->_tid_prefix = 'PAYOLUTION_INS';
...
MainFactory::load_origin_class('skrill_payins');
?>
