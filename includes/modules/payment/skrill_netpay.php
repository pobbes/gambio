<?php
/* -----------------------------------------------------------------------------------------
   $Id: skrill_netpay.php 39 2009-01-22 15:44:52Z mzanier $
...
class skrill_netpay_ORIGIN extends fcnt_skrill {

	var $images='eps.gif';

	// class constructor
	function skrill_netpay_ORIGIN() {
...
MainFactory::load_origin_class('skrill_netpay');
?>
