...
$contents[] = array ('align' => 'center',
					 'text' => '<div align="center"><a class="button" href="Javascript:void()" onclick="window.open(\''.xtc_href_link('mediafinanz.php', 'action=display&popup=true&cID='.$cInfo->customers_id).'\', \'popup\', \'toolbar=0, width=700, height=500\')">Bonit&auml;ts&uuml;bersicht</a></div>');
//MEDIAFINANZ END
?>