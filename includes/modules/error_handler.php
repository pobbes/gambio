<?php
/* --------------------------------------------------------------
   error_handler.php 2012-06-27 gm
   Gambio GmbH
   http://www.gambio.de
...
(c) 2003 XT-Commerce - community made shopping http://www.xt-commerce.com ($Id: error_handler.php 949 2005-05-14 16:44:33Z hhgag $) 
  ...
  // search field
  $module_smarty->assign('FORM_ACTION',xtc_draw_form('new_find', xtc_href_link(FILENAME_ADVANCED_SEARCH_RESULT, '', 'NONSSL', false, true, true), 'get').xtc_hide_session_id());
  $module_smarty->assign('INPUT_SEARCH',xtc_draw_input_field('keywords', '', 'size="30" maxlength="30"'));
  $module_smarty->assign('INPUT_SEARCH_NAME', 'keywords');
  $module_smarty->assign('BUTTON_SUBMIT',xtc_image_submit('button_quick_find.gif'));
