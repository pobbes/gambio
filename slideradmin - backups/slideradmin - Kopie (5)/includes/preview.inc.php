    <div id="list">
        ...
        <ul>
            ...
            <li id="arrayorder_<?php echo $img_id ?>" class="preview_list">
                ...
                <form action="" method="get" enctype="form-data" class="right preview_form">
                    <?php if($img_is_active == '1') { ?> 
                    <div class="preview_input left">
                        <button id="deactivate_image" class="icon-check-empty icon-large" type="submit" value="<?php echo $img_id ?>" name="deactivate" title="Bild deaktivieren"></button>
                    </div>
                    <?php }else { ?>
                    <div class="preview_input left">
                        <button id="activate_image"   class="icon-check icon-large"       type="submit" value="<?php echo $img_id ?>" name="activate"  title="Bild aktivieren"></button>
                    </div>
                    <?php } ?>     
