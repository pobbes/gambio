...
function setSlides($id) {
    ...
    echo "<div id=\"response\">Einstellungen gespeichert</div>";
...
function activateImage($id) {
    ...
    echo "<div id=\"response\">Bild aktiviert</div>";
...
function deactivateImage($id) {
    ...
    echo "<div id=\"response\">Bild deaktiviert</div>";
...
function deleteImage($id) {
    ...
    if (!unlink($path."/".$pathToImage)) {      
        ...
        echo "<div id=\"response\">Bild Gel&ouml;scht</div>";
