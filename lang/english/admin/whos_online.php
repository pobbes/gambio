<?php
/* --------------------------------------------------------------
   whos_online.php 2008-08-10 gambio
   Gambio OHG
   http://www.gambio.de
   ...
   (c) 2003 XT-Commerce - community made shopping http://www.xt-commerce.com ($Id: whos_online.php 899 2005-04-29 02:40:57Z hhgag $)

   Released under the GNU General Public License 
   --------------------------------------------------------------*/

define('HEADING_TITLE', 'Who is Online');
...
define('TABLE_HEADING_SHOPPING_CART', 'User\'s Shopping Cart');
define('TEXT_SHOPPING_CART_SUBTOTAL', 'Subtotal');
define('TEXT_NUMBER_OF_CUSTOMERS', 'There are currently %s customers online');
define('TEXT_NUMBER_OF_CUSTOMER', 'There are currently %s customers online');
?>