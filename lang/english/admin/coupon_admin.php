...
define('TEXT_TO_REDEEM', 'You can redeem this coupon during the checkout process. Simply enter the code in the box provided and click on the redeem button.');
define('TEXT_IN_CASE', ' if you experience any problems. ');
define('TEXT_VOUCHER_IS', 'The coupon code is ');
define('TEXT_REMEMBER', 'Do not lose the coupon code; keep the code safe to enable you to benefit from this special offer.');
...
define('Kupon_VALUE', 'Coupon Value');
...
define('COUPON_CATEGORIES', 'Valid Category List');
...
define('TEXT_NEW_INTRO', 'Please enter the following information for the new coupon.<br>');


define('COUPON_NAME_HELP', 'A short name for the coupon');
define('COUPON_AMOUNT_HELP', 'The coupon discount value, either a fixed sum, or add a % at the end for a percentage discount.');
define('COUPON_CODE_HELP', 'You can enter your own code here or leave blank to generate a code automatically.');
define('COUPON_STARTDATE_HELP', 'Coupon is valid from');
define('COUPON_FINISHDATE_HELP', 'Coupon expires on');
define('COUPON_FREE_SHIP_HELP', 'The coupon entitles the customer to free shipping on an order.');
define('COUPON_DESC_HELP', 'A description of the coupon for the customer');
define('COUPON_MIN_ORDER_HELP', 'The minimum order value before the coupon can be used');
