...
define('TEXT_INFO_PRODUCTS_VPE_NAME', 'Order status:');
...
define('ERROR_REMOVE_DEFAULT_PRODUCTS_VPE', 'Error: The default packing unit cannot be removed. Please set another packing unit as the default and try again.');
?>