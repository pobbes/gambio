...
define('MODULE_PAYMENT_CC_TEXT_DESCRIPTION', 'Credit card test info:<br /><br />CC#: 4111111111111111<br />Expiry: Any date');
define('MODULE_PAYMENT_CC_TEXT_CREDIT_CARD_TYPE', 'Credit Card Type:');
define('MODULE_PAYMENT_CC_TEXT_CREDIT_CARD_OWNER', 'Credit Card Holder:');
...
define('MODULE_PAYMENT_CC_TEXT_JS_CC_OWNER', '* The credit card holder name must contain at least ' . CC_OWNER_MIN_LENGTH . ' characters.\n');
define('MODULE_PAYMENT_CC_TEXT_JS_CC_NUMBER', '* The credit card number must contain at least ' . CC_NUMBER_MIN_LENGTH . ' characters.\n');
define('MODULE_PAYMENT_CC_TEXT_ERROR', 'Credit Card Error!');
define('TEXT_CARD_NOT_ACZEPTED','Sorry, we do not accept <b>%s</b> cards, please use another card type!<br />We accept the following credit cards: ');
define('MODULE_PAYMENT_CC_TEXT_JS_CC_CVV', 'The CVV number is a required field and must be completed.\n Orders cannot be submitted without it.\n The CVV number comprises the last 3 or 4 (American Express) digits printed on the signature strip on the reverse of your card.');
define('MODULE_PAYMENT_CC_TEXT_CVV_LINK', '<u>[help?]</u>');
define('HEADING_CVV', 'Security Code Help Screen');
define('TEXT_CVV', '<tablealign="center" cellspacing="2" cellpadding="5" width="400"><tr><td><span class="table Heading"><b>Visa, Mastercard, Discover 3-Digit Card Verification Number</b></span></td></tr><tr><td><span class="boxText">For your security we require you to enter the verification number on your card. The verification number is a 3-digit number printed on the reverse of your card. It appears after and to the right of the last 4 digits of your card number.</span></td></tr><tr><td align="center"><IMG src="images/cv_card.gif"></td></tr></table><hr /><table align="center" cell spacing="2" cell padding="5" width="400"><tr><td><span class="main"><b>American Express 4-Digit Card Verification Number</b> </span></td></tr><tr><td><span class="boxText">For your security we require you to enter the verification number on your card. The American Express verification number is a 4-digit number printed on the front of your card. It appears after and to the right of your card number.</span></td></tr><tr><td align="center"><IMG src="images/cv_amex_card.gif"></td></tr></table>');
define('TEXT_CLOSE_WINDOW', '<u>Close Window</u> [x]');
define('MODULE_PAYMENT_CC_ACCEPTED_CARDS','We accept the following cards:');
...
define('MODULE_PAYMENT_CC_ALLOWED_DESC' , 'Please enter the zones <b>individually</b> that should be allowed to use this module (e.g. US, UK (leave blank to allow all zones))');
...
define('MODULE_PAYMENT_CC_SORT_ORDER_TITLE', 'Display Sort Order');
define('MODULE_PAYMENT_CC_SORT_ORDER_DESC', 'Display sort order; the lowest value is displayed first.');
define('MODULE_PAYMENT_CC_ZONE_TITLE', 'Payment Zone');
define('MODULE_PAYMENT_CC_ZONE_DESC', 'When a zone is selected, this payment method will be enabled for that zone only.');
define('MODULE_PAYMENT_CC_ORDER_STATUS_ID_TITLE', 'Set Order Status');
define('MODULE_PAYMENT_CC_ORDER_STATUS_ID_DESC', 'Set the status of orders made using this payment module to this value');
define('USE_CC_CVV_TITLE', 'Collect CVV Number');
define('USE_CC_CVV_DESC', 'Do you want to collect the CVV number?');
define('USE_CC_ISS_TITLE', 'Collect Issue Number');
define('USE_CC_ISS_DESC', 'Do you want to collect the issue number?');
...
define('MODULE_PAYMENT_CC_EMAIL_DESC', 'If an email address is entered, the central digits of the card number will be sent to the email address (the end digits are stored in the database with the central digits censored');
define('TEXT_CCVAL_ERROR_INVALID_DATE', 'The "valid to" date is invalid.<br />Please correct your information.');
define('TEXT_CCVAL_ERROR_INVALID_NUMBER', 'The "credit card number" you entered is invalid.<br />Please correct your information.');
define('TEXT_CCVAL_ERROR_UNKNOWN_CARD', 'The first 4 digits of your credit card are: %s<br />If this information is correct, your card type is not accepted.<br />Please correct your information.');
