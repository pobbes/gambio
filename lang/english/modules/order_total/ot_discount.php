...
/* -----------------------------------------------------------------------------------------
  ...
  define('MODULE_ORDER_TOTAL_DISCOUNT_STATUS_TITLE', 'Display Discount on Total');
  define('MODULE_ORDER_TOTAL_DISCOUNT_STATUS_DESC', 'Do you want to display the discount on the order total?');

  define('MODULE_ORDER_TOTAL_DISCOUNT_SORT_ORDER_TITLE', 'Sort Order');
  define('MODULE_ORDER_TOTAL_DISCOUNT_SORT_ORDER_DESC','Display sort order');
?>