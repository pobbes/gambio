...
/* -----------------------------------------------------------------------------------------
  ...
  define('MODULE_ORDER_TOTAL_LOWORDERFEE_SORT_ORDER_DESC','Display sort order.');

  define('MODULE_ORDER_TOTAL_LOWORDERFEE_LOW_ORDER_FEE_TITLE','Allow Low Order Fee');
  define('MODULE_ORDER_TOTAL_LOWORDERFEE_LOW_ORDER_FEE_DESC','Do you want to allow the low order fee?');
  ...
  define('MODULE_ORDER_TOTAL_LOWORDERFEE_DESTINATION_TITLE','Add Low Order Fee to Orders Made');
  define('MODULE_ORDER_TOTAL_LOWORDERFEE_DESTINATION_DESC','Add low order fee to orders sent to this destination.');

  define('MODULE_ORDER_TOTAL_LOWORDERFEE_TAX_CLASS_TITLE','Tax Class');
  define('MODULE_ORDER_TOTAL_LOWORDERFEE_TAX_CLASS_DESC','Apply the following tax class to the low order fee.');
?>