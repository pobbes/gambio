...
/* -----------------------------------------------------------------------------------------
  ...
  define('MODULE_ORDER_TOTAL_TAX_TITLE', 'Sales Tax');
  define('MODULE_ORDER_TOTAL_TAX_DESCRIPTION', 'Sales tax on order');

  define('MODULE_ORDER_TOTAL_TAX_STATUS_TITLE','Display Sales Tax');
  ...
  define('MODULE_ORDER_TOTAL_TAX_SORT_ORDER_DESC','Display sort order');
?>