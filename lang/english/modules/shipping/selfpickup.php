...
define('MODULE_SHIPPING_SELFPICKUP_TEXT_TITLE', 'Self Pickup.');
define('MODULE_SHIPPING_SELFPICKUP_TEXT_WAY', 'Self Pickup from our company.');
define('MODULE_SHIPPING_SELFPICKUP_ALLOWED_TITLE' , 'Allowed Zones');
define('MODULE_SHIPPING_SELFPICKUP_ALLOWED_DESC' , 'Please enter the zones <b>individually</b> that should be allowed to use this module (e.g. US, UK (leave blank to allow all zones))');
define('MODULE_SHIPPING_SELFPICKUP_STATUS_TITLE', 'Enable Self Pickup');
define('MODULE_SHIPPING_SELFPICKUP_STATUS_DESC', 'Do you want to offer self pickup by the customer?');
define('MODULE_SHIPPING_SELFPICKUP_SORT_ORDER_TITLE', 'Sort Order');
define('MODULE_SHIPPING_SELFPICKUP_SORT_ORDER_DESC', 'Display sort order.');
?>