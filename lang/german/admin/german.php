...
// page title
define('TITLE', 'Gambio GX2 Adminbereich');
...
define('BOX_API_TOOL', 'Jetzt API-Signatur von PayPal erhalten');
define('BOX_PAYPAL_EXPRESS_HINT', 'Hinweis:<br />Die Verwendung von PayPal Express in Verbindung mit Guthaben und Downlo Adartikeln ist technisch nicht m&ouml;glich!<br />Dies bedeutet, dass der Kunde im Bezahlvorgang kein Guthaben w&auml;hlen kann und Downloadartikel nicht mit PayPal Express gezahlt werden k&ouml;nnen!');
...
define('BOX_CONFIGURATION_8', 'Artikel&uuml;bersicht-Optionen');
...
define('BOX_CONFIGURATION_16', 'Suchmaschinen');
define('BOX_CONFIGURATION_17', 'Zusatzmodule');
define('BOX_CONFIGURATION_18', 'USt-IdNr.');
define('BOX_CONFIGURATION_19', 'Schnittstellen');
define('BOX_CONFIGURATION_22', 'Such-Optionen');
define('BOX_CONFIGURATION_21', 'Schnittstellen');
define('BOX_CONFIGURATION_25', 'Schnittstellen');
...
define('BOX_PAYMENT', 'Zahlungsweisen');
define('BOX_SHIPPING', 'Versandarten');
define('BOX_ORDER_TOTAL', 'Zusammenfassung');
define('BOX_CATEGORIES', 'Artikel / Kategorien');
define('BOX_PRODUCTS_ATTRIBUTES', 'Artikelattribute');
...
define('BOX_COUNTRIES', 'L&auml;nder');
...
define('BOX_SHOW_LOGS', 'Logs anzeigen');
define('BOX_CLEAR_CACHE', 'Seitencache leeren');
...
define('BOX_ATTRIBUTES_MANAGER','Attributverwaltung');
...
define('BOX_MODULE_EXPORT','Modul-Center');
...
define('BOX_COUPON_ADMIN','Rabatt Kupons');
define('BOX_TOOLS_BLACKLIST','Kreditkarten sperren');
define('BOX_IMPORT','CSV Import / Export');
define('BOX_PRODUCTS_VPE','Verpackungseinheiten');
...
define('BOX_XTBOOSTER_LISTAUCTIONS','eBay Auktionen anzeigen');
...
define('JS_DOB', '* Das \'Geburtsdatum\' muss folgendes Format haben: tt.mm.jjjj (Tag/Jahr/Monat).\n');
...
define('TEXT_CHOOSE_INFO_TEMPLATE','Vorlage f&uuml;r Artikeldetailseite');
define('TEXT_CHOOSE_OPTIONS_TEMPLATE','Vorlage f&uuml;r Artikelattribute');
...
define('TEXT_PAYMENT_ERROR','<b>Hinweis:</b><br />Bitte aktivieren Sie ein Zahlungsmodul!');
define('TEXT_SHIPPING_ERROR','<b>Hinweis:</b><br />Bitte aktivieren Sie ein Versandmodul!');
...
define('SECURITY_CODE_LENGTH_TITLE', 'L&auml;nge des Gutschein-Codes');
define('SECURITY_CODE_LENGTH_DESC', 'Geben Sie hier die L&auml;nge des Gutschein-Code ein. (max. 16 Zeichen)');

define('NEW_SIGNUP_GIFT_VOUCHER_AMOUNT_TITLE', 'Willkommens-Geschenk Gutscheinwert');
define('NEW_SIGNUP_GIFT_VOUCHER_AMOUNT_DESC', 'Willkommens-Geschenk Gutscheinwert: Wenn Sie keinen Gutschein in Ihrer Willkommens-E-Mail versenden wollen, tragen Sie hier 0 ein, ansonsten geben Sie den Wert des Gutscheins an. Z. B. 10.00 oder 50.00, aber keine W&auml;hrungszeichen');
...
define('ENTRY_VAT_ID_ERROR', '<font color="#FF0000">* Die Eingegebene USt-IdNr. ist falsch oder kann derzeit nicht gepr&uuml;ft werden!</font>');
...
define('GM_QUICK_SEARCH_CUSTOMER', 'KUNDE');
define('GM_QUICK_SEARCH_ORDER_ID', 'BESTELLNUMMER');
define('GM_QUICK_SEARCH_ARTICLE', 'ARTIKEL');

define('GM_TOP_MENU_CREDITS', 'Credits');
define('GM_TOP_MENU_START', 'Start');
define('GM_TOP_MENU_SHOP', 'Shop');
define('GM_TOP_MENU_PREVIEW', 'Vorschau');
define('GM_TOP_MENU_LOGOUT', 'Logout');
define('GM_TOP_MENU_CLEARCACHE', 'Seitencache leeren');
define('GM_TOP_MENU_CLEARCACHE_HINT', 'Sie haben &Auml;nderungen vorgenommen, die m&ouml;glicherweise die Seitenausgabe im Shop betreffen.<br />Leeren Sie den Seitenausgabe-Cache, um die &Auml;nderungen im Shop sichtbar zu machen.');
define('GM_TOP_MENU_CACHE_EMPTIED', 'Der Seitencache wurde geleert.');

// BOF GM_MOD
include(DIR_FS_LANGUAGES . 'german/admin/gm_german.php');
// EOF GM_MOD
...
define('_PAYMENT_SKRILL_EXPERTMODE_TITLE', 'Expertenmodus');
define('_PAYMENT_SKRILL_EXPERTMODE_DESC', 'Bitte ver&auml;ndern Sie diesen Wert nur in Absprache mit Skrill! (Standard: 0)');
...
// BOF GM_MOD
define('TEXT_NO_CONTENT', 'Der Inhalt konnte nicht geladen werden, da der Server derzeit nicht zu erreichen ist. Bitte versuchen Sie es sp&auml;ter noch einmal.');
define('TEXT_CONTENT_LOADING', 'Der Inhalt wird geladen...');
// EOF GM_MOD

define('ERROR_QUICKSEARCH_ORDER_ID', 'Es kann nur nach einer Bestellnummer gesucht werden.');
?>