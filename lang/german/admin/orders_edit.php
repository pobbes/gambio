...
define('HEADING_WARNING', '<br /><strong><font face="arial" style="font-size: 11px"><font color="#FF0000">ACHTUNG:</font> Bitte beachten Sie, dass das Modul zur manuellen Bestellnachbearbeitung unter Umst&auml;nden nicht korrekt arbeitet. Bitte &uuml;berprüfen Sie alle errechneten Werte auf deren Korrektheit.</strong></font><br /><br />');
