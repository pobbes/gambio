...
define('YOOCHOOSE_SECRET_DESC', 'Mit diesem Schlüssel weisen Sie Ihre Identität nach. Er verhindert das unbefugte Lesen und Ändern Ihrer Einstellungen. Geben Sie Ihren Lizenzschlüssel daher niemals an Dritte weiter!');
...
define('YOOCHOOSE_RECO_TOP_SELLING', 'Empfehlungen "Häufig gekauft"');
...
define('YOOCHOOSE_ESTIMATED_OVERSIZE', 'Vorausichtliche Dateiengröße ist %1$s. Das Hochladen über %2$s Mb ist nicht empfohlen. Reduzieren Sie die Zeitspanne.');
define('YOOCHOOSE_PRODUCTS_TO_UPLOAD', 'Produkte zum Hochladen: %1$s. Vorausichtliche Dateiengröße ist: %2$s.');

define('YOOCHOOSE_UPLOAD_FAILED', 'Fehler wärhend der Übemittlung an den Empfehlungsdienst. %1$s');
...
'Durch den Einsatz von YOOCHOOSE Empfehlungsdienst können Ihre Umsätze um bis zu 30% steigern.');


define('YOOCHOOSE_ACTIVATE_PREINFO',
    'Bevor Sie den YOOCHOOSE Empfehlungsdienst konfigurieren und nutzen können, brauchen Sie das Modul zu aktivieren. 
...
define('YOOCHOOSE_ACTIVATE_POSTINFO',
    'Das Registrierungsformular auf YOOCHOOSE Webseite wird für Sie bereits vorgefüllt. Dafür werden folgende Daten aus dem Shop 
    System verschlüsset übertragen: Ihren Namen, Firmennamen und Adresse. Alle Daten werden Ihnen gleich danach zur Bestätigung
    vorgelegt und können von Ihnen korregiert werden. Wenn Sie disese Übermittelung vermeiden wollen,
    können die auch ein <a target="_blank" href="%1$s">leeres Registrierungsformular</a> benutzen.');


define('YOOCHOOSE_TOO_OLD_PHP_VERSION',
    'Ihre PHP version ist zu alt für das Modul. YOOCHOOSE Modul benötigt mindestsns PHP Version %2$s. Ihre Version ist %1$s.');
    
define('YOOCHOOSE_DATETIME_MISSING',
    'Für das Modul wird die Klasse DateTime benötigt. Sie wurde in Ihrem PHP nicht gefunden. Prüfen Sie bitte Ihre Konfiguration.');
...
define('YOOCHOOSE_LOG_LEVEL_DESC',   'Definiert das Log-Level für Dateien /export/recommendations-*.log');
