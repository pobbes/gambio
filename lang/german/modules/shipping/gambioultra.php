<?php
/* --------------------------------------------------------------
   gambioultra.php 2008-07-27 gambio
   Gambio OHG
   http://www.gambio.de
...
$gmLangFileMaster->define_lang_file_content('lang/german/modules/shipping/gambioultra.php');
/*

define('MODULE_SHIPPING_GAMBIOULTRA_TEXT_TITLE', 'Artikel-Versandkosten');
define('MODULE_SHIPPING_GAMBIOULTRA_TEXT_DESCRIPTION', 'Die Versandkosten können artikelweise beim Bearbeiten eines Artikels eingetragen werden.');
define('MODULE_SHIPPING_GAMBIOULTRA_TEXT_WAY', 'Versand nach:');
define('MODULE_SHIPPING_GAMBIOULTRA_TEXT_UNITS', 'kg');
define('MODULE_SHIPPING_GAMBIOULTRA_INVALID_ZONE', 'Es ist kein Versand in dieses Land m&ouml;glich!');
define('MODULE_SHIPPING_GAMBIOULTRA_UNDEFINED_RATE', 'Unversicherter Versand nicht möglich. Bitte andere Versandart wählen.');

define('MODULE_SHIPPING_GAMBIOULTRA_STATUS_TITLE' , 'Versandkosten nach Zonen Methode aktivieren');
define('MODULE_SHIPPING_GAMBIOULTRA_STATUS_DESC' , 'M&ouml;chten Sie Versandkosten nach Zonen anbieten?');
define('MODULE_SHIPPING_GAMBIOULTRA_ALLOWED_TITLE' , 'Erlaubte Versandzonen');
define('MODULE_SHIPPING_GAMBIOULTRA_ALLOWED_DESC' , 'Geben Sie <b>einzeln</b> die Zonen an, in welche ein Versand möglich sein soll. (z.B. AT,DE (lassen Sie dieses Feld leer, wenn Sie alle Zonen erlauben wollen))');
define('MODULE_SHIPPING_GAMBIOULTRA_TAX_CLASS_TITLE' , 'Steuerklasse');
define('MODULE_SHIPPING_GAMBIOULTRA_TAX_CLASS_DESC' , 'Folgende Steuerklasse an Versandkosten anwenden');
define('MODULE_SHIPPING_GAMBIOULTRA_SORT_ORDER_TITLE' , 'Sortierreihenfolge');
define('MODULE_SHIPPING_GAMBIOULTRA_SORT_ORDER_DESC' , 'Reihenfolge der Anzeige');

define('MODULE_SHIPPING_GAMBIOULTRA_COUNTRIES_1_TITLE' , 'Zone 1 L&auml;nder');
define('MODULE_SHIPPING_GAMBIOULTRA_COUNTRIES_1_DESC' , 'Durch Komma getrennte Liste von ISO L&auml;ndercodes (2 Zeichen), welche Teil von Zone 1 sind.');
define('MODULE_SHIPPING_GAMBIOULTRA_COST_1_TITLE' , 'Zone 1 Versandkosten');
define('MODULE_SHIPPING_GAMBIOULTRA_COST_1_DESC' , 'Versandkosten nach Zone 1 Bestimmungsorte, basierend auf einer Gruppe von max. Bestellgewichten. Beispiel: 3:8.50,7:10.50,... Gewicht von kleiner oder gleich 3 w&uuml;rde 8.50 für die Zone 1 Bestimmungsl&auml;nder kosten.');
define('MODULE_SHIPPING_GAMBIOULTRA_HANDLING_1_TITLE' , 'Zone 1 Handling Geb&uuml;hr');
define('MODULE_SHIPPING_GAMBIOULTRA_HANDLING_1_DESC' , 'Handling Geb&uuml;hr für diese Versandzone');
