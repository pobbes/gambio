<?php
/* --------------------------------------------------------------
   banktransfer.php 2008-07-16 gambio
   Gambio OHG
   http://www.gambio.de
   ...
   (c) 2003 XT-Commerce - community made shopping http://www.xt-commerce.com ($Id: banktransfer.php 998 2005-07-07 14:18:20Z mz $)
...
$gmLangFileMaster->define_lang_file_content('lang/german/modules/payment/banktransfer.php');
...
define('MODULE_PAYMENT_BANKTRANSFER_DATACHECK_TITLE', 'Bankdaten pr&uuml;fen?');
define('MODULE_PAYMENT_BANKTRANSFER_DATACHECK_DESC', 'Sollen die eingegebenen Bankdaten &uuml;berpr&uuml;ft werden?');#
*/
?>