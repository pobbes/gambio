<?php
/* --------------------------------------------------------------
   eustandardtransfer.php 2008-07-16 gambio
   Gambio OHG
   http://www.gambio.de
...
$gmLangFileMaster->define_lang_file_content('lang/german/modules/payment/eustandardtransfer.php');
...
//                                                     '<br />Sort Code: ' . MODULE_PAYMENT_EUTRANSFER_SORTCODE .
  ...
  define('MODULE_PAYMENT_EUTRANSFER_TEXT_INFO','Umgehend nach Zahlungseingang wird die Ware von uns verschickt.');
