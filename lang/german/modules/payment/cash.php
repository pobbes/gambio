...
/* --------------------------------------------------------------
   ...
   (c) 2003 XT-Commerce - community made shopping http://www.xt-commerce.com ($Id: cash.php 1102 2005-07-24 15:05:38Z mz $)

   Released under the GNU General Public License
   ---------------------------------------------------------------------------------------*/
global $gmLangFileMaster;
$gmLangFileMaster->define_lang_file_content('lang/german/modules/payment/cash.php');

/*
define('MODULE_PAYMENT_CASH_TEXT_DESCRIPTION', 'Barzahlung');
define('MODULE_PAYMENT_CASH_TEXT_TITLE', 'Barzahlung');
define('MODULE_PAYMENT_CASH_TEXT_INFO', 'Bezahlung in bar');
