...
/* --------------------------------------------------------------
   ...
   (c) 2003 XT-Commerce - community made shopping http://www.xt-commerce.com ($Id: invoice.php 998 2005-07-07 14:18:20Z mz $)

   Released under the GNU General Public License
   ---------------------------------------------------------------------------------------*/
global $gmLangFileMaster;
$gmLangFileMaster->define_lang_file_content('lang/german/modules/payment/invoice.php');

/*
  define('MODULE_PAYMENT_INVOICE_TEXT_DESCRIPTION', 'Rechnung');
  define('MODULE_PAYMENT_INVOICE_TEXT_TITLE', 'Rechnung');
  define('MODULE_PAYMENT_INVOICE_TEXT_INFO','Zahlung per Rechnung');
...
define('MODULE_PAYMENT_INVOICE_MIN_ORDER_DESC' , 'Die Mindestanzahl an Bestellungen die ein Kunden haben muss damit die Option zur Verf�gung steht.');
*/
?>