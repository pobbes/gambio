...
/* --------------------------------------------------------------
   ...
   (c) 2003 XT-Commerce - community made shopping http://www.xt-commerce.com ($Id: cod.php 998 2005-07-07 14:18:20Z mz $)

   Released under the GNU General Public License 
   ---------------------------------------------------------------------------------------*/
global $gmLangFileMaster;
$gmLangFileMaster->define_lang_file_content('lang/german/modules/payment/cod.php');
...
// BOF GM_MOD:
define('MODULE_PAYMENT_COD_TEXT_INFO', 'Zahlung per Nachnahme');
